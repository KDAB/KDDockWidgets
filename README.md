...
```
Our brand new [manual](https://kdab.github.io/KDDockWidgets/) is now the entry point for every thing related to `KDDockWidgets`.
This README only provides some minimal information.
```
