                                                                                          ...
                                                                                          bool useOffset) const
{
    ...
    const Vector<QPoint> leftPoints = { topLeft, bottomLeft, QPoint(left, bottom) + QPoint(l, -l),
                                        topLeft + QPoint(l, l), topLeft };

    const Vector<QPoint> rightPoints = { topRight, bottomRight, bottomRight + QPoint(-l, -l),
                                         topRight + QPoint(-l, l) };

    const Vector<QPoint> topPoints = { topLeft, topRight, topRight + QPoint(-l, l),
                                       topLeft + QPoint(l, l) };

    const Vector<QPoint> bottomPoints = { bottomLeft, bottomRight, bottomRight + QPoint(-l, -l),
                                          bottomLeft + QPoint(l, -l) };

    if (inner) {
        QPolygon bounds =
            Vector<QPoint> { topLeft + QPoint(l, l), topRight + QPoint(-l, l),
        ...
        const auto center = Vector<QPoint> {
