...
// tag=1014
static KDDockWidgets_wrappersNS::QString_wrapper *fromWrapperPtr(void *ptr)
{
    return reinterpret_cast<KDDockWidgets_wrappersNS::QString_wrapper *>(ptr);
}
extern "C" {
...
{
    delete reinterpret_cast<KDDockWidgets_wrappersNS::QString_wrapper *>(cppObj);
}
void *c_QString__constructor()
{

    // tag=1056
    auto ptr = new KDDockWidgets_wrappersNS::QString_wrapper();
...
void *c_static_QString__asprintf_char(const char *format)
{
    return
        ...
        // tag=1072
        new Dartagnan::ValueWrapper<QString> { KDDockWidgets_wrappersNS::QString_wrapper::asprintf(format) };
}
...
int c_static_QString__compare_QString_QString(const char *s1_, const char *s2_)
{
    ...
    return
        // tag=1068
        KDDockWidgets_wrappersNS::QString_wrapper::compare(s1, s2);
}
...
void *c_static_QString__fromLatin1_QByteArray(void *str_)
{
    ...
    return
        ...
        // tag=1072
        new Dartagnan::ValueWrapper<QString> { KDDockWidgets_wrappersNS::QString_wrapper::fromLatin1(str) };
}
...
void *c_static_QString__fromLatin1_char_int(const char *str, int size)
{
    return
        ...
        // tag=1072
        new Dartagnan::ValueWrapper<QString> { KDDockWidgets_wrappersNS::QString_wrapper::fromLatin1(str, size) };
}
...
void *c_static_QString__fromLocal8Bit_QByteArray(void *str_)
{
    ...
    return
        ...
        // tag=1072
        new Dartagnan::ValueWrapper<QString> { KDDockWidgets_wrappersNS::QString_wrapper::fromLocal8Bit(str) };
}
...
void *c_static_QString__fromLocal8Bit_char_int(const char *str, int size)
{
    return
        ...
        // tag=1072
        new Dartagnan::ValueWrapper<QString> { KDDockWidgets_wrappersNS::QString_wrapper::fromLocal8Bit(str, size) };
}
...
void *c_static_QString__fromUtf8_QByteArray(void *str_)
{
    ...
    return
        ...
        // tag=1072
        new Dartagnan::ValueWrapper<QString> { KDDockWidgets_wrappersNS::QString_wrapper::fromUtf8(str) };
}
...
void *c_static_QString__fromUtf8_char_int(const char *str, int size)
{
    return
        ...
        // tag=1072
        new Dartagnan::ValueWrapper<QString> { KDDockWidgets_wrappersNS::QString_wrapper::fromUtf8(str, size) };
}
...
int c_static_QString__localeAwareCompare_QString_QString(const char *s1_, const char *s2_)
{
    ...
    return
        // tag=1068
        KDDockWidgets_wrappersNS::QString_wrapper::localeAwareCompare(s1, s2);
}
...
void *c_static_QString__number_int_int(int arg__1, int base)
{
    return
        ...
        // tag=1072
        new Dartagnan::ValueWrapper<QString> { KDDockWidgets_wrappersNS::QString_wrapper::number(arg__1, base) };
}
