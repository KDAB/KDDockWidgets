...
// tag=1014
static KDDockWidgets_wrappersNS::View_wrapper *fromWrapperPtr(void *ptr)
{
    return reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper *>(ptr);
}
extern "C" {
...
{
    delete reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper *>(cppObj);
}
// tag=1050
...
{
    // tag=1016
    [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->activateWindow_nocallback();} else {    return targetPtr->activateWindow();} }();
}
...
void *c_static_KDDockWidgets__View__boundedMaxSize_QSize_QSize(void *min_, void *max_)
{
    ...
    return
        ...
        // tag=1072
        new Dartagnan::ValueWrapper<QSize> { KDDockWidgets_wrappersNS::View_wrapper::boundedMaxSize(min, max) };
}
...
bool c_KDDockWidgets__View__close(void *thisObj)
{
    return
        // tag=1016
        [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->close_nocallback();} else {    return targetPtr->close();} }();
}
...
{
    // tag=1016
    [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->createPlatformWindow_nocallback();} else {    return targetPtr->createPlatformWindow();} }();
}
...
bool c_static_KDDockWidgets__View__equals_View_View(void *one_, void *two_)
{
    ...
    return
        // tag=1068
        KDDockWidgets_wrappersNS::View_wrapper::equals(one, two);
}
...
void *c_KDDockWidgets__View__geometry(void *thisObj)
{
    return
        ...
        // tag=1072
        new Dartagnan::ValueWrapper<QRect> { [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->geometry_nocallback();} else {    return targetPtr->geometry();} }() };
}
...
{
    // tag=1016
    [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->grabMouse_nocallback();} else {    return targetPtr->grabMouse();} }();
}
...
void *c_static_KDDockWidgets__View__hardcodedMinimumSize()
{
    return
        ...
        // tag=1072
        new Dartagnan::ValueWrapper<QSize> { KDDockWidgets_wrappersNS::View_wrapper::hardcodedMinimumSize() };
}
...
bool c_KDDockWidgets__View__hasFocus(void *thisObj)
{
    return
        // tag=1016
        [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->hasFocus_nocallback();} else {    return targetPtr->hasFocus();} }();
}
...
{
    // tag=1016
    [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->hide_nocallback();} else {    return targetPtr->hide();} }();
}
...
{
    // tag=1016
    [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->init_nocallback();} else {    return targetPtr->init();} }();
}
...
bool c_KDDockWidgets__View__isActiveWindow(void *thisObj)
{
    return
        // tag=1016
        [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->isActiveWindow_nocallback();} else {    return targetPtr->isActiveWindow();} }();
}
...
bool c_KDDockWidgets__View__isMaximized(void *thisObj)
{
    return
        // tag=1016
        [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->isMaximized_nocallback();} else {    return targetPtr->isMaximized();} }();
}
...
bool c_KDDockWidgets__View__isMinimized(void *thisObj)
{
    return
        // tag=1016
        [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->isMinimized_nocallback();} else {    return targetPtr->isMinimized();} }();
}
...
bool c_KDDockWidgets__View__isNull(void *thisObj)
{
    return
        // tag=1016
        [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->isNull_nocallback();} else {    return targetPtr->isNull();} }();
}
...
bool c_KDDockWidgets__View__isRootView(void *thisObj)
{
    return
        // tag=1016
        [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->isRootView_nocallback();} else {    return targetPtr->isRootView();} }();
}
...
bool c_KDDockWidgets__View__isVisible(void *thisObj)
{
    return
        // tag=1016
        [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->isVisible_nocallback();} else {    return targetPtr->isVisible();} }();
}
...
void *c_KDDockWidgets__View__mapFromGlobal_QPoint(void *thisObj, void *arg__1_)
{
    ...
    return
        ...
        // tag=1072
        new Dartagnan::ValueWrapper<QPoint> { [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->mapFromGlobal_nocallback(arg__1);} else {    return targetPtr->mapFromGlobal(arg__1);} }() };
}
...
void *c_KDDockWidgets__View__mapTo_View_QPoint(void *thisObj, void *arg__1_, void *arg__2_)
{
    ...
    return
        ...
        // tag=1072
        new Dartagnan::ValueWrapper<QPoint> { [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->mapTo_nocallback(arg__1,arg__2);} else {    return targetPtr->mapTo(arg__1,arg__2);} }() };
}
...
void *c_KDDockWidgets__View__mapToGlobal_QPoint(void *thisObj, void *arg__1_)
{
    ...
    return
        ...
        // tag=1072
        new Dartagnan::ValueWrapper<QPoint> { [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->mapToGlobal_nocallback(arg__1);} else {    return targetPtr->mapToGlobal(arg__1);} }() };
}
...
void *c_KDDockWidgets__View__maxSizeHint(void *thisObj)
{
    return
        ...
        // tag=1072
        new Dartagnan::ValueWrapper<QSize> { [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->maxSizeHint_nocallback();} else {    return targetPtr->maxSizeHint();} }() };
}
...
void *c_KDDockWidgets__View__maximumSize(void *thisObj)
{
    return
        ...
        // tag=1072
        new Dartagnan::ValueWrapper<QSize> { [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->maximumSize_nocallback();} else {    return targetPtr->maximumSize();} }() };
}
...
void *c_KDDockWidgets__View__minSize(void *thisObj)
{
    return
        ...
        // tag=1072
        new Dartagnan::ValueWrapper<QSize> { [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->minSize_nocallback();} else {    return targetPtr->minSize();} }() };
}
...
int c_KDDockWidgets__View__minimumHeight(void *thisObj)
{
    return
        // tag=1016
        [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->minimumHeight_nocallback();} else {    return targetPtr->minimumHeight();} }();
}
...
int c_KDDockWidgets__View__minimumWidth(void *thisObj)
{
    return
        // tag=1016
        [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->minimumWidth_nocallback();} else {    return targetPtr->minimumWidth();} }();
}
...
{
    // tag=1016
    [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->move_nocallback(x,y);} else {    return targetPtr->move(x,y);} }();
}
...
void *c_KDDockWidgets__View__normalGeometry(void *thisObj)
{
    return
        ...
        // tag=1072
        new Dartagnan::ValueWrapper<QRect> { [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->normalGeometry_nocallback();} else {    return targetPtr->normalGeometry();} }() };
}
...
void *c_KDDockWidgets__View__objectName(void *thisObj)
{
    return
        ...
        // tag=1072
        new Dartagnan::ValueWrapper<QString> { [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->objectName_nocallback();} else {    return targetPtr->objectName();} }() };
}
...
bool c_KDDockWidgets__View__onResize_QSize(void *thisObj, void *newSize_)
{
    ...
    return
        // tag=1016
        [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->onResize_nocallback(newSize);} else {    return targetPtr->onResize(newSize);} }();
}
...
{
    // tag=1016
    [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->raise_nocallback();} else {    return targetPtr->raise();} }();
}
...
{
    // tag=1016
    [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->raiseAndActivate_nocallback();} else {    return targetPtr->raiseAndActivate();} }();
}
...
{
    // tag=1016
    [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->releaseKeyboard_nocallback();} else {    return targetPtr->releaseKeyboard();} }();
}
...
{
    // tag=1016
    [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->releaseMouse_nocallback();} else {    return targetPtr->releaseMouse();} }();
}
...
{
    // tag=1016
    [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->setFixedHeight_nocallback(arg__1);} else {    return targetPtr->setFixedHeight(arg__1);} }();
}
...
{
    // tag=1016
    [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->setFixedWidth_nocallback(arg__1);} else {    return targetPtr->setFixedWidth(arg__1);} }();
}
...
void c_KDDockWidgets__View__setGeometry_QRect(void *thisObj, void *arg__1_)
{
    ...
    // tag=1016
    [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->setGeometry_nocallback(arg__1);} else {    return targetPtr->setGeometry(arg__1);} }();
}
...
{
    // tag=1016
    [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->setHeight_nocallback(height);} else {    return targetPtr->setHeight(height);} }();
}
...
void c_KDDockWidgets__View__setMaximumSize_QSize(void *thisObj, void *sz_)
{
    ...
    // tag=1016
    [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->setMaximumSize_nocallback(sz);} else {    return targetPtr->setMaximumSize(sz);} }();
}
...
void c_KDDockWidgets__View__setMinimumSize_QSize(void *thisObj, void *arg__1_)
{
    auto &arg__1 = *reinterpret_cast<QSize *>(arg__1_);
    // tag=1016
    [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->setMinimumSize_nocallback(arg__1);} else {    return targetPtr->setMinimumSize(arg__1);} }();
}
...
{
    // tag=1016
    [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->setMouseTracking_nocallback(arg__1);} else {    return targetPtr->setMouseTracking(arg__1);} }();
}
...
void c_KDDockWidgets__View__setObjectName_QString(void *thisObj, const char *arg__1_)
{
    ...
    // tag=1016
    [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->setObjectName_nocallback(arg__1);} else {    return targetPtr->setObjectName(arg__1);} }();
}
...
void c_KDDockWidgets__View__setParent_View(void *thisObj, void *arg__1_)
{
    auto arg__1 = reinterpret_cast<KDDockWidgets::View *>(arg__1_);
    // tag=1016
    [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->setParent_nocallback(arg__1);} else {    return targetPtr->setParent(arg__1);} }();
}
...
{
    // tag=1016
    [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->setSize_nocallback(width,height);} else {    return targetPtr->setSize(width,height);} }();
}
...
{
    // tag=1016
    [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->setVisible_nocallback(arg__1);} else {    return targetPtr->setVisible(arg__1);} }();
}
...
{
    // tag=1016
    [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->setWidth_nocallback(width);} else {    return targetPtr->setWidth(width);} }();
}
...
{
    // tag=1016
    [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->setWindowOpacity_nocallback(arg__1);} else {    return targetPtr->setWindowOpacity(arg__1);} }();
}
...
void c_KDDockWidgets__View__setWindowTitle_QString(void *thisObj, const char *title_)
{
    ...
    // tag=1016
    [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->setWindowTitle_nocallback(title);} else {    return targetPtr->setWindowTitle(title);} }();
}
...
{
    // tag=1016
    [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->setZOrder_nocallback(arg__1);} else {    return targetPtr->setZOrder(arg__1);} }();
}
...
{
    // tag=1016
    [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->show_nocallback();} else {    return targetPtr->show();} }();
}
...
{
    // tag=1016
    [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->showMaximized_nocallback();} else {    return targetPtr->showMaximized();} }();
}
...
{
    // tag=1016
    [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->showMinimized_nocallback();} else {    return targetPtr->showMinimized();} }();
}
...
{
    // tag=1016
    [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->showNormal_nocallback();} else {    return targetPtr->showNormal();} }();
}
...
void *c_KDDockWidgets__View__sizeHint(void *thisObj)
{
    return
        ...
        // tag=1072
        new Dartagnan::ValueWrapper<QSize> { [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->sizeHint_nocallback();} else {    return targetPtr->sizeHint();} }() };
}
...
{
    // tag=1016
    [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgets_wrappersNS::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->update_nocallback();} else {    return targetPtr->update();} }();
}
...
void c_KDDockWidgets__View__registerVirtualMethodCallback(void *ptr, void *callback, int methodId)
{
    ...
    switch (methodId) {
    case 602:
        wrapper->m_activateWindowCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_activateWindow>(callback);
        break;
    case 604:
        wrapper->m_closeCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_close>(callback);
        break;
    case 606:
        wrapper->m_createPlatformWindowCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_createPlatformWindow>(callback);
        break;
    case 610:
        wrapper->m_free_implCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_free_impl>(callback);
        break;
    case 612:
        wrapper->m_geometryCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_geometry>(callback);
        break;
    case 614:
        wrapper->m_grabMouseCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_grabMouse>(callback);
        break;
    case 617:
        wrapper->m_hasFocusCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_hasFocus>(callback);
        break;
    case 619:
        wrapper->m_hideCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_hide>(callback);
        break;
    case 622:
        wrapper->m_initCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_init>(callback);
        break;
    case 623:
        wrapper->m_isActiveWindowCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_isActiveWindow>(callback);
        break;
    case 624:
        wrapper->m_isMaximizedCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_isMaximized>(callback);
        break;
    case 625:
        wrapper->m_isMinimizedCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_isMinimized>(callback);
        break;
    case 626:
        wrapper->m_isNullCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_isNull>(callback);
        break;
    case 627:
        wrapper->m_isRootViewCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_isRootView>(callback);
        break;
    case 628:
        wrapper->m_isVisibleCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_isVisible>(callback);
        break;
    case 629:
        wrapper->m_mapFromGlobalCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_mapFromGlobal>(callback);
        break;
    case 630:
        wrapper->m_mapToCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_mapTo>(callback);
        break;
    case 631:
        wrapper->m_mapToGlobalCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_mapToGlobal>(callback);
        break;
    case 632:
        wrapper->m_maxSizeHintCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_maxSizeHint>(callback);
        break;
    case 633:
        wrapper->m_maximumSizeCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_maximumSize>(callback);
        break;
    case 634:
        wrapper->m_minSizeCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_minSize>(callback);
        break;
    case 635:
        wrapper->m_minimumHeightCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_minimumHeight>(callback);
        break;
    case 636:
        wrapper->m_minimumWidthCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_minimumWidth>(callback);
        break;
    case 638:
        wrapper->m_move_2Callback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_move_2>(callback);
        break;
    case 639:
        wrapper->m_normalGeometryCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_normalGeometry>(callback);
        break;
    case 640:
        wrapper->m_objectNameCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_objectName>(callback);
        break;
    case 641:
        wrapper->m_onResizeCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_onResize>(callback);
        break;
    case 644:
        wrapper->m_raiseCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_raise>(callback);
        break;
    case 645:
        wrapper->m_raiseAndActivateCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_raiseAndActivate>(callback);
        break;
    case 647:
        wrapper->m_releaseKeyboardCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_releaseKeyboard>(callback);
        break;
    case 648:
        wrapper->m_releaseMouseCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_releaseMouse>(callback);
        break;
    case 652:
        wrapper->m_setFixedHeightCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_setFixedHeight>(callback);
        break;
    case 653:
        wrapper->m_setFixedWidthCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_setFixedWidth>(callback);
        break;
    case 654:
        wrapper->m_setGeometryCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_setGeometry>(callback);
        break;
    case 655:
        wrapper->m_setHeightCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_setHeight>(callback);
        break;
    case 656:
        wrapper->m_setMaximumSizeCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_setMaximumSize>(callback);
        break;
    case 657:
        wrapper->m_setMinimumSizeCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_setMinimumSize>(callback);
        break;
    case 658:
        wrapper->m_setMouseTrackingCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_setMouseTracking>(callback);
        break;
    case 659:
        wrapper->m_setObjectNameCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_setObjectName>(callback);
        break;
    case 660:
        wrapper->m_setParentCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_setParent>(callback);
        break;
    case 662:
        wrapper->m_setSize_2Callback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_setSize_2>(callback);
        break;
    case 663:
        wrapper->m_setVisibleCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_setVisible>(callback);
        break;
    case 664:
        wrapper->m_setWidthCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_setWidth>(callback);
        break;
    case 665:
        wrapper->m_setWindowOpacityCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_setWindowOpacity>(callback);
        break;
    case 666:
        wrapper->m_setWindowTitleCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_setWindowTitle>(callback);
        break;
    case 667:
        wrapper->m_setZOrderCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_setZOrder>(callback);
        break;
    case 668:
        wrapper->m_showCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_show>(callback);
        break;
    case 669:
        wrapper->m_showMaximizedCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_showMaximized>(callback);
        break;
    case 670:
        wrapper->m_showMinimizedCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_showMinimized>(callback);
        break;
    case 671:
        wrapper->m_showNormalCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_showNormal>(callback);
        break;
    case 673:
        wrapper->m_sizeHintCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_sizeHint>(callback);
        break;
    case 674:
        wrapper->m_updateCallback = reinterpret_cast<KDDockWidgets_wrappersNS::View_wrapper::Callback_update>(callback);
        break;
    }
}
}
