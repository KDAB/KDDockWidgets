...
// tag=1014
template<typename T>
static KDDockWidgets_wrappersNS::QList_wrapper<T> *fromWrapperPtr(void *ptr)
{
    return reinterpret_cast<KDDockWidgets_wrappersNS::QList_wrapper<T> *>(ptr);
}
extern "C" {
...
{
    delete reinterpret_cast<KDDockWidgets_wrappersNS::QList_wrapper<QObject *> *>(cppObj);
}
void *c_QList_T_QObject_T___constructor()
{

    // tag=1056
    auto ptr = new KDDockWidgets_wrappersNS::QList_wrapper<QObject *>();
...
{
    delete reinterpret_cast<KDDockWidgets_wrappersNS::QList_wrapper<QByteArray> *>(cppObj);
}
void *c_QList_T_QByteArray_T___constructor()
{

    // tag=1056
    auto ptr = new KDDockWidgets_wrappersNS::QList_wrapper<QByteArray>();
    return reinterpret_cast<void *>(ptr);
}
