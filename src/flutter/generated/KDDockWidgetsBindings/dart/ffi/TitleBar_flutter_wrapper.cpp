...
void c_KDDockWidgets__Views__TitleBar_flutter__registerVirtualMethodCallback(void *ptr, void *callback, int methodId)
{
    ...
    case 957:
        ...
        break;
    case 1024:
        wrapper->m_onChildAddedCallback = reinterpret_cast<KDDockWidgetsBindings_wrappersNS::TitleBar_flutter_wrapper::Callback_onChildAdded>(callback);
        break;
    case 1025:
        wrapper->m_onChildRemovedCallback = reinterpret_cast<KDDockWidgetsBindings_wrappersNS::TitleBar_flutter_wrapper::Callback_onChildRemoved>(callback);
        break;
    case 959:
        wrapper->m_onResize_2Callback = reinterpret_cast<KDDockWidgetsBindings_wrappersNS::TitleBar_flutter_wrapper::Callback_onResize_2>(callback);
        break;
    case 962:
