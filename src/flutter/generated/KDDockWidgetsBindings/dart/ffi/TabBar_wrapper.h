...
KDDockWidgetsBindings_EXPORT void *c_KDDockWidgets__Controllers__TabBar__constructor_Stack(void *tabWidget_);
...
KDDockWidgetsBindings_EXPORT void *c_KDDockWidgets__Controllers__TabBar__currentDockWidget(void *thisObj);
// KDDockWidgets::Controllers::TabBar::currentDockWidgetChanged(KDDockWidgets::Controllers::DockWidget * arg__1)
KDDockWidgetsBindings_EXPORT void c_KDDockWidgets__Controllers__TabBar__currentDockWidgetChanged_DockWidget(void *thisObj, void *arg__1_);
...
KDDockWidgetsBindings_EXPORT void c_KDDockWidgets__Controllers__TabBar__customEvent_QEvent(void *thisObj, void *event_);
// KDDockWidgets::Controllers::TabBar::dockWidgetAt(QPoint localPos) const
KDDockWidgetsBindings_EXPORT void *c_KDDockWidgets__Controllers__TabBar__dockWidgetAt_QPoint(void *thisObj, void *localPos_);
// KDDockWidgets::Controllers::TabBar::dockWidgetAt(int index) const
KDDockWidgetsBindings_EXPORT void *c_KDDockWidgets__Controllers__TabBar__dockWidgetAt_int(void *thisObj, int index);
// KDDockWidgets::Controllers::TabBar::dragCanStart(QPoint pressPos, QPoint pos) const
KDDockWidgetsBindings_EXPORT bool c_KDDockWidgets__Controllers__TabBar__dragCanStart_QPoint_QPoint(void *thisObj, void *pressPos_, void *pos_);
// KDDockWidgets::Controllers::TabBar::event(QEvent * event)
KDDockWidgetsBindings_EXPORT bool c_KDDockWidgets__Controllers__TabBar__event_QEvent(void *thisObj, void *event_);
// KDDockWidgets::Controllers::TabBar::eventFilter(QObject * watched, QEvent * event)
KDDockWidgetsBindings_EXPORT bool c_KDDockWidgets__Controllers__TabBar__eventFilter_QObject_QEvent(void *thisObj, void *watched_, void *event_);
...
KDDockWidgetsBindings_EXPORT bool c_KDDockWidgets__Controllers__TabBar__hasSingleDockWidget(void *thisObj);
// KDDockWidgets::Controllers::TabBar::indexOfDockWidget(const KDDockWidgets::Controllers::DockWidget * dw) const
KDDockWidgetsBindings_EXPORT int c_KDDockWidgets__Controllers__TabBar__indexOfDockWidget_DockWidget(void *thisObj, void *dw_);
...
KDDockWidgetsBindings_EXPORT void c_KDDockWidgets__Controllers__TabBar__moveTabTo_int_int(void *thisObj, int from, int to);
// KDDockWidgets::Controllers::TabBar::numDockWidgets() const
KDDockWidgetsBindings_EXPORT int c_KDDockWidgets__Controllers__TabBar__numDockWidgets(void *thisObj);
// KDDockWidgets::Controllers::TabBar::onMouseDoubleClick(QPoint localPos)
KDDockWidgetsBindings_EXPORT void c_KDDockWidgets__Controllers__TabBar__onMouseDoubleClick_QPoint(void *thisObj, void *localPos_);
// KDDockWidgets::Controllers::TabBar::onMousePress(QPoint localPos)
KDDockWidgetsBindings_EXPORT void c_KDDockWidgets__Controllers__TabBar__onMousePress_QPoint(void *thisObj, void *localPos_);
// KDDockWidgets::Controllers::TabBar::rectForTab(int index) const
KDDockWidgetsBindings_EXPORT void *c_KDDockWidgets__Controllers__TabBar__rectForTab_int(void *thisObj, int index);
// KDDockWidgets::Controllers::TabBar::removeDockWidget(KDDockWidgets::Controllers::DockWidget * dw)
KDDockWidgetsBindings_EXPORT void c_KDDockWidgets__Controllers__TabBar__removeDockWidget_DockWidget(void *thisObj, void *dw_);
// KDDockWidgets::Controllers::TabBar::renameTab(int index, const QString & arg__2)
KDDockWidgetsBindings_EXPORT void c_KDDockWidgets__Controllers__TabBar__renameTab_int_QString(void *thisObj, int index, const char *arg__2_);
...
KDDockWidgetsBindings_EXPORT bool c_KDDockWidgets__Controllers__TabBar__tabsAreMovable(void *thisObj);
// KDDockWidgets::Controllers::TabBar::text(int index) const
KDDockWidgetsBindings_EXPORT void *c_KDDockWidgets__Controllers__TabBar__text_int(void *thisObj, int index);
// KDDockWidgets::Controllers::TabBar::tr(const char * s, const char * c, int n)
KDDockWidgetsBindings_EXPORT void *c_static_KDDockWidgets__Controllers__TabBar__tr_char_char_int(const char *s, const char *c, int n);
KDDockWidgetsBindings_EXPORT void c_KDDockWidgets__Controllers__TabBar__destructor(void *thisObj);
KDDockWidgetsBindings_EXPORT void c_KDDockWidgets__Controllers__TabBar__registerVirtualMethodCallback(void *ptr, void *callback, int methodId);
KDDockWidgetsBindings_EXPORT void c_KDDockWidgets__Controllers__TabBar_Finalizer(void *, void *cppObj, void *);
}
