...
public:
    ...
    virtual bool tests_waitForEvent(KDDockWidgets::View *arg__1, QEvent::Type type, int timeout = 5000) const;
    virtual bool tests_waitForEvent_nocallback(KDDockWidgets::View *arg__1, QEvent::Type type, int timeout = 5000) const;
    virtual bool tests_waitForEvent(QObject *w, QEvent::Type type, int timeout = 5000) const;
    virtual bool tests_waitForEvent_nocallback(QObject *w, QEvent::Type type, int timeout = 5000) const;
...
KDDockWidgetsBindings_EXPORT void c_KDDockWidgets__Platform__sendEvent_View_QEvent(void *thisObj, void *arg__1_, void *arg__2_);
