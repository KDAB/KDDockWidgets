...
KDDockWidgets::View *Platform_wrapper::createView(KDDockWidgets::Controller *arg__1, KDDockWidgets::View *parent) const
{
...
void Platform_wrapper::indirection()
{
...
KDDockWidgets::View *Platform_wrapper::tests_createFocusableView(KDDockWidgets::CreateViewOptions arg__1, KDDockWidgets::View *parent)
{
...
KDDockWidgets::View *Platform_wrapper::tests_createFocusableView_nocallback(KDDockWidgets::CreateViewOptions arg__1, KDDockWidgets::View *parent)
{
    qWarning() << Q_FUNC_INFO << "Warning: Calling pure-virtual";
    return {};
}
...
KDDockWidgets::View *Platform_wrapper::tests_createView(KDDockWidgets::CreateViewOptions arg__1, KDDockWidgets::View *parent)
{
...
KDDockWidgets::View *Platform_wrapper::tests_createView_nocallback(KDDockWidgets::CreateViewOptions arg__1, KDDockWidgets::View *parent)
{
    qWarning() << Q_FUNC_INFO << "Warning: Calling pure-virtual";
    return {};
}
...
bool Platform_wrapper::tests_waitForEvent(KDDockWidgets::View *arg__1, QEvent::Type type, int timeout) const
{
...
bool Platform_wrapper::tests_waitForEvent_nocallback(KDDockWidgets::View *arg__1, QEvent::Type type, int timeout) const
{
    qWarning() << Q_FUNC_INFO << "Warning: Calling pure-virtual";
    return {};
}
...
bool Platform_wrapper::tests_waitForEvent_nocallback(QObject *w, QEvent::Type type, int timeout) const
{
    qWarning() << Q_FUNC_INFO << "Warning: Calling pure-virtual";
    return {};
}
...
{
    KDDockWidgetsBindings_wrappersNS::Platform_wrapper::indirection();
}
...
void c_KDDockWidgets__Platform__sendEvent_View_QEvent(void *thisObj, void *arg__1_, void *arg__2_)
{
    ...
    [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgetsBindings_wrappersNS::Platform_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->sendEvent_nocallback(arg__1,arg__2);} else {    return targetPtr->sendEvent(arg__1,arg__2);} }();
}
...
bool c_KDDockWidgets__Platform__tests_waitForEvent_QObject_Type_int(void *thisObj, void *w_, int type, int timeout)
{
    ...
    return [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgetsBindings_wrappersNS::Platform_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->tests_waitForEvent_nocallback(w,static_cast<QEvent::Type>(type),timeout);} else {    return targetPtr->tests_waitForEvent(w,static_cast<QEvent::Type>(type),timeout);} }();
}
...
void c_KDDockWidgets__Platform__registerVirtualMethodCallback(void *ptr, void *callback, int methodId)
{
    ...
    case 744:
        ...
        break;
    case 745:
        wrapper->m_sendEventCallback = reinterpret_cast<KDDockWidgetsBindings_wrappersNS::Platform_wrapper::Callback_sendEvent>(callback);
        break;
    case 746:
