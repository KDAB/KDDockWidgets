...
public:
    ...
    virtual void setGeometry(QRect arg__1) const;
    virtual void setGeometry_nocallback(QRect arg__1) const;
...
extern "C" {
// KDDockWidgets::flutter::Window::Window()
KDDockWidgetsBindings_EXPORT void *c_KDDockWidgets__flutter__Window__constructor();
...
// KDDockWidgets::flutter::Window::setGeometry(QRect arg__1) const
