...
namespace KDDockWidgetsBindings_wrappersNS {namespace KDDWBindingsCore {class Stack_wrapper : public ::KDDockWidgets::Core::Stack {public:
~Stack_wrapper();void addDockWidget(KDDockWidgets::Core::DockWidget * arg__1);bool contains(KDDockWidgets::Core::DockWidget * dw)const;KDDockWidgets::Core::Group * group()const;bool insertDockWidget(KDDockWidgets::Core::DockWidget * dockwidget,int index);virtual bool isMDI()const;virtual bool isMDI_nocallback()const;virtual bool isPositionDraggable(KDDockWidgets::Point p)const;virtual bool isPositionDraggable_nocallback(KDDockWidgets::Point p)const;virtual bool isWindow()const;virtual bool isWindow_nocallback()const;int numDockWidgets()const;bool onMouseDoubleClick(KDDockWidgets::Point localPos);void setDocumentMode(bool arg__1);virtual void setParentView_impl(KDDockWidgets::Core::View * parent);virtual void setParentView_impl_nocallback(KDDockWidgets::Core::View * parent);void setTabBarAutoHide(bool arg__1);KDDockWidgets::Core::TabBar * tabBar()const;bool tabBarAutoHide()const;typedef bool (*Callback_isMDI)(void *);Callback_isMDI m_isMDICallback = nullptr;typedef bool (*Callback_isPositionDraggable)(void *,KDDockWidgets::Point* p);Callback_isPositionDraggable m_isPositionDraggableCallback = nullptr;typedef bool (*Callback_isWindow)(void *);Callback_isWindow m_isWindowCallback = nullptr;typedef void (*Callback_setParentView_impl)(void *,KDDockWidgets::Core::View * parent);Callback_setParentView_impl m_setParentView_implCallback = nullptr;typedef KDDockWidgets::Core::DockWidget * (*Callback_singleDockWidget)(void *);Callback_singleDockWidget m_singleDockWidgetCallback = nullptr;
...
DOCKS_EXPORT void c_KDDockWidgets__Core__Stack__registerVirtualMethodCallback(void *ptr, void *callback, int methodId);DOCKS_EXPORT  void c_KDDockWidgets__Core__Stack_Finalizer(void *cppObj);}
