...
namespace KDDockWidgetsBindings_wrappersNS {namespace KDDWBindingsCore {class DropArea_wrapper : public ::KDDockWidgets::Core::DropArea {public:
~DropArea_wrapper(); DropArea_wrapper(KDDockWidgets::Core::View * parent,QFlags<KDDockWidgets::MainWindowOption> options,bool isMDIWrapper = false);void _addDockWidget(KDDockWidgets::Core::DockWidget * dw,KDDockWidgets::Location location,KDDockWidgets::Core::Item * relativeTo,const KDDockWidgets::InitialOption & initialOption);void addDockWidget(KDDockWidgets::Core::DockWidget * dw,KDDockWidgets::Location location,KDDockWidgets::Core::DockWidget * relativeTo,const KDDockWidgets::InitialOption & initialOption = {});void addMultiSplitter(KDDockWidgets::Core::DropArea * splitter,KDDockWidgets::Location location,KDDockWidgets::Core::Group * relativeToGroup = nullptr,const KDDockWidgets::InitialOption & option = KDDockWidgets::DefaultSizeMode::Fair);void addWidget(KDDockWidgets::Core::View * widget,KDDockWidgets::Location location,KDDockWidgets::Core::Item * relativeToItem = nullptr,const KDDockWidgets::InitialOption & option = KDDockWidgets::DefaultSizeMode::Fair);KDDockWidgets::Core::Item * centralFrame()const;bool containsDockWidget(KDDockWidgets::Core::DockWidget * arg__1)const;static KDDockWidgets::Core::Group * createCentralGroup(QFlags<KDDockWidgets::MainWindowOption> options);KDDockWidgets::DropLocation currentDropLocation()const;KDDockWidgets::Core::DropIndicatorOverlay * dropIndicatorOverlay()const;bool hasSingleFloatingGroup()const;bool hasSingleGroup()const;bool isMDIWrapper()const;void layoutEqually();void layoutParentContainerEqually(KDDockWidgets::Core::DockWidget * arg__1);KDDockWidgets::Core::DockWidget * mdiDockWidgetWrapper()const;void removeHover();virtual void setParentView_impl(KDDockWidgets::Core::View * parent);virtual void setParentView_impl_nocallback(KDDockWidgets::Core::View * parent);typedef void (*Callback_setParentView_impl)(void *,KDDockWidgets::Core::View * parent);Callback_setParentView_impl m_setParentView_implCallback = nullptr;
...
// KDDockWidgets::Core::DropArea::_addDockWidget(KDDockWidgets::Core::DockWidget * dw, KDDockWidgets::Location location, KDDockWidgets::Core::Item * relativeTo, const KDDockWidgets::InitialOption & initialOption)
...
DOCKS_EXPORT void c_KDDockWidgets__Core__DropArea__registerVirtualMethodCallback(void *ptr, void *callback, int methodId);DOCKS_EXPORT  void c_KDDockWidgets__Core__DropArea_Finalizer(void *cppObj);}
