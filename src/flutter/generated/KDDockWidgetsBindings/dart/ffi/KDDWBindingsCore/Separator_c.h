...
namespace KDDockWidgetsBindings_wrappersNS {namespace KDDWBindingsCore {class Separator_wrapper : public ::KDDockWidgets::Core::Separator {public:
~Separator_wrapper(); Separator_wrapper(KDDockWidgets::Core::View * host);static bool isResizing();bool isVertical()const;void move(int p);static int numSeparators();void onMouseDoubleClick();void onMouseMove(QPoint pos);void onMousePress();void onMouseReleased();int position()const;void setGeometry(QRect r);void setGeometry(int pos,int pos2,int length);virtual void setParentView_impl(KDDockWidgets::Core::View * parent);virtual void setParentView_impl_nocallback(KDDockWidgets::Core::View * parent);typedef void (*Callback_setParentView_impl)(void *,KDDockWidgets::Core::View * parent);Callback_setParentView_impl m_setParentView_implCallback = nullptr;
...
KDDockWidgetsBindings_EXPORT void c_KDDockWidgets__Core__Separator__registerVirtualMethodCallback(void *ptr, void *callback, int methodId);KDDockWidgetsBindings_EXPORT  void c_KDDockWidgets__Core__Separator_Finalizer(void *, void *cppObj, void *);}
