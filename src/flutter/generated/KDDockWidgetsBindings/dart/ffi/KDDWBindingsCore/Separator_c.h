...
~Separator_wrapper();static bool isResizing();bool isVertical()const;static int numSeparators();void onMouseDoubleClick();void onMouseMove(KDDockWidgets::Point pos);void onMousePress();void onMouseReleased();int position()const;void setGeometry(KDDockWidgets::Rect r);virtual void setParentView_impl(KDDockWidgets::Core::View * parent);virtual void setParentView_impl_nocallback(KDDockWidgets::Core::View * parent);typedef void (*Callback_setParentView_impl)(void *,KDDockWidgets::Core::View * parent);Callback_setParentView_impl m_setParentView_implCallback = nullptr;
...
DOCKS_EXPORT void c_KDDockWidgets__Core__Separator__registerVirtualMethodCallback(void *ptr, void *callback, int methodId);DOCKS_EXPORT  void c_KDDockWidgets__Core__Separator_Finalizer(void *cppObj);}
