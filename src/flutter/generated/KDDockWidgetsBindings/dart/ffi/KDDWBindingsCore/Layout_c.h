...
~Layout_wrapper(); Layout_wrapper(KDDockWidgets::Core::ViewType arg__1,KDDockWidgets::Core::View * arg__2);KDDockWidgets::Core::DropArea * asDropArea()const;bool checkSanity()const;void clearLayout();bool containsGroup(const KDDockWidgets::Core::Group * arg__1)const;bool containsItem(const KDDockWidgets::Core::Item * arg__1)const;int count()const;void dumpLayout()const;KDDockWidgets::Core::FloatingWindow * floatingWindow()const;bool isInMainWindow(bool honourNesting = false)const;KDDockWidgets::Core::Item * itemForGroup(const KDDockWidgets::Core::Group * group)const;int layoutHeight()const;KDDockWidgets::Size layoutMaximumSizeHint()const;KDDockWidgets::Size layoutMinimumSize()const;KDDockWidgets::Size layoutSize()const;int layoutWidth()const;KDDockWidgets::Core::MainWindow * mainWindow(bool honourNesting = false)const;int placeholderCount()const;void removeItem(KDDockWidgets::Core::Item * item);void restorePlaceholder(KDDockWidgets::Core::DockWidget * dw,KDDockWidgets::Core::Item * arg__2,int tabIndex);void setLayoutMinimumSize(KDDockWidgets::Size arg__1);void setLayoutSize(KDDockWidgets::Size arg__1);virtual void setParentView_impl(KDDockWidgets::Core::View * parent);virtual void setParentView_impl_nocallback(KDDockWidgets::Core::View * parent);void updateSizeConstraints();void viewAboutToBeDeleted();int visibleCount()const;typedef void (*Callback_setParentView_impl)(void *,KDDockWidgets::Core::View * parent);Callback_setParentView_impl m_setParentView_implCallback = nullptr;
...
DOCKS_EXPORT void c_KDDockWidgets__Core__Layout__registerVirtualMethodCallback(void *ptr, void *callback, int methodId);DOCKS_EXPORT  void c_KDDockWidgets__Core__Layout_Finalizer(void *cppObj);}
