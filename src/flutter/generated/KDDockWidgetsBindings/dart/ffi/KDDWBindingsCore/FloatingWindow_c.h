...
~FloatingWindow_wrapper(); FloatingWindow_wrapper(KDDockWidgets::Core::Group * group,KDDockWidgets::Rect suggestedGeometry,KDDockWidgets::Core::MainWindow * parent = nullptr); FloatingWindow_wrapper(KDDockWidgets::Rect suggestedGeometry,KDDockWidgets::Core::MainWindow * parent = nullptr);void addDockWidget(KDDockWidgets::Core::DockWidget * arg__1,KDDockWidgets::Location location,KDDockWidgets::Core::DockWidget * relativeTo,const KDDockWidgets::InitialOption & arg__4 = {});bool allDockWidgetsHave(KDDockWidgets::DockWidgetOption arg__1)const;bool allDockWidgetsHave(KDDockWidgets::LayoutSaverOption arg__1)const;bool anyDockWidgetsHas(KDDockWidgets::DockWidgetOption arg__1)const;bool anyDockWidgetsHas(KDDockWidgets::LayoutSaverOption arg__1)const;bool anyNonClosable()const;bool anyNonDockable()const;bool beingDeleted()const;KDDockWidgets::Margins contentMargins()const;KDDockWidgets::Rect dragRect()const;KDDockWidgets::Core::DropArea * dropArea()const;static void ensureRectIsOnScreen(KDDockWidgets::Rect & geometry);bool hasSingleDockWidget()const;bool hasSingleGroup()const;bool isInDragArea(KDDockWidgets::Point globalPoint)const;virtual bool isMDI()const;virtual bool isMDI_nocallback()const;bool isUtilityWindow()const;virtual bool isWindow()const;virtual bool isWindow_nocallback()const;KDDockWidgets::Core::Layout * layout()const;KDDockWidgets::Core::MainWindow * mainWindow()const;void maybeCreateResizeHandler();KDDockWidgets::Core::DropArea * multiSplitter()const;void scheduleDeleteLater();virtual void setParentView_impl(KDDockWidgets::Core::View * parent);virtual void setParentView_impl_nocallback(KDDockWidgets::Core::View * parent);void setSuggestedGeometry(KDDockWidgets::Rect suggestedRect);KDDockWidgets::Core::Group * singleFrame()const;bool supportsMaximizeButton()const;bool supportsMinimizeButton()const;KDDockWidgets::Core::TitleBar * titleBar()const;void updateTitleAndIcon();void updateTitleBarVisibility();int userType()const;typedef bool (*Callback_isMDI)(void *);Callback_isMDI m_isMDICallback = nullptr;typedef bool (*Callback_isWindow)(void *);Callback_isWindow m_isWindowCallback = nullptr;typedef void (*Callback_setParentView_impl)(void *,KDDockWidgets::Core::View * parent);Callback_setParentView_impl m_setParentView_implCallback = nullptr;typedef KDDockWidgets::Core::DockWidget * (*Callback_singleDockWidget)(void *);Callback_singleDockWidget m_singleDockWidgetCallback = nullptr;
...
// KDDockWidgets::Core::FloatingWindow::addDockWidget(KDDockWidgets::Core::DockWidget * arg__1, KDDockWidgets::Location location, KDDockWidgets::Core::DockWidget * relativeTo, const KDDockWidgets::InitialOption & arg__4)
...
DOCKS_EXPORT void c_KDDockWidgets__Core__FloatingWindow__registerVirtualMethodCallback(void *ptr, void *callback, int methodId);DOCKS_EXPORT  void c_KDDockWidgets__Core__FloatingWindow_Finalizer(void *cppObj);}
