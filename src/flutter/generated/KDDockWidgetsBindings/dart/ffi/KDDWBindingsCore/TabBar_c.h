...
namespace KDDockWidgetsBindings_wrappersNS {namespace KDDWBindingsCore {class TabBar_wrapper : public ::KDDockWidgets::Core::TabBar {public:
~TabBar_wrapper(); TabBar_wrapper(KDDockWidgets::Core::Stack * tabWidget = nullptr);KDDockWidgets::Core::DockWidget * currentDockWidget()const;int currentIndex()const;KDDockWidgets::Core::DockWidget * dockWidgetAt(KDDockWidgets::Point localPos)const;KDDockWidgets::Core::DockWidget * dockWidgetAt(int index)const;virtual bool dragCanStart(KDDockWidgets::Point pressPos,KDDockWidgets::Point pos)const;virtual bool dragCanStart_nocallback(KDDockWidgets::Point pressPos,KDDockWidgets::Point pos)const;KDDockWidgets::Core::Group * group()const;bool hasSingleDockWidget()const;int indexOfDockWidget(const KDDockWidgets::Core::DockWidget * dw)const;virtual bool isMDI()const;virtual bool isMDI_nocallback()const;bool isMovingTab()const;virtual bool isWindow()const;virtual bool isWindow_nocallback()const;void moveTabTo(int from,int to);int numDockWidgets()const;void onMouseDoubleClick(KDDockWidgets::Point localPos);void onMousePress(KDDockWidgets::Point localPos);KDDockWidgets::Rect rectForTab(int index)const;void removeDockWidget(KDDockWidgets::Core::DockWidget * dw);void renameTab(int index,const QString & arg__2);void setCurrentDockWidget(KDDockWidgets::Core::DockWidget * dw);void setCurrentIndex(int index);virtual void setParentView_impl(KDDockWidgets::Core::View * parent);virtual void setParentView_impl_nocallback(KDDockWidgets::Core::View * parent);KDDockWidgets::Core::Stack * stack()const;bool tabsAreMovable()const;QString text(int index)const;typedef bool (*Callback_dragCanStart)(void *,KDDockWidgets::Point* pressPos,KDDockWidgets::Point* pos);Callback_dragCanStart m_dragCanStartCallback = nullptr;typedef bool (*Callback_isMDI)(void *);Callback_isMDI m_isMDICallback = nullptr;typedef bool (*Callback_isWindow)(void *);Callback_isWindow m_isWindowCallback = nullptr;typedef void (*Callback_setParentView_impl)(void *,KDDockWidgets::Core::View * parent);Callback_setParentView_impl m_setParentView_implCallback = nullptr;typedef KDDockWidgets::Core::DockWidget * (*Callback_singleDockWidget)(void *);Callback_singleDockWidget m_singleDockWidgetCallback = nullptr;
...
DOCKS_EXPORT void c_KDDockWidgets__Core__TabBar__registerVirtualMethodCallback(void *ptr, void *callback, int methodId);DOCKS_EXPORT  void c_KDDockWidgets__Core__TabBar_Finalizer(void *cppObj);}
