...
namespace KDDockWidgetsBindings_wrappersNS {namespace KDDWBindingsCore {class TitleBar_wrapper : public ::KDDockWidgets::Core::TitleBar {public:
~TitleBar_wrapper(); TitleBar_wrapper(KDDockWidgets::Core::FloatingWindow * parent); TitleBar_wrapper(KDDockWidgets::Core::Group * parent); TitleBar_wrapper(KDDockWidgets::Core::View * arg__1);bool closeButtonEnabled()const;QString floatButtonToolTip()const;bool floatButtonVisible()const;KDDockWidgets::Core::FloatingWindow * floatingWindow()const;KDDockWidgets::Core::Group * group()const;bool hasIcon()const;bool isCloseButtonEnabled()const;bool isCloseButtonVisible()const;bool isFloatButtonVisible()const;bool isFloating()const;bool isFocused()const;virtual bool isMDI()const;virtual bool isMDI_nocallback()const;bool isOverlayed()const;bool isStandalone()const;virtual bool isWindow()const;virtual bool isWindow_nocallback()const;KDDockWidgets::Core::MainWindow * mainWindow()const;bool maximizeButtonVisible()const;void onAutoHideClicked();void onCloseClicked();bool onDoubleClicked();void onFloatClicked();void onMaximizeClicked();void onMinimizeClicked();void setCloseButtonEnabled(bool arg__1);void setCloseButtonVisible(bool arg__1);void setFloatButtonVisible(bool arg__1);virtual void setParentView_impl(KDDockWidgets::Core::View * parent);virtual void setParentView_impl_nocallback(KDDockWidgets::Core::View * parent);void setTitle(const QString & title);bool supportsAutoHideButton()const;bool supportsFloatingButton()const;bool supportsMaximizeButton()const;bool supportsMinimizeButton()const;KDDockWidgets::Core::TabBar * tabBar()const;QString title()const;bool titleBarIsFocusable()const;void toggleMaximized();void updateButtons();typedef bool (*Callback_isMDI)(void *);Callback_isMDI m_isMDICallback = nullptr;typedef bool (*Callback_isWindow)(void *);Callback_isWindow m_isWindowCallback = nullptr;typedef void (*Callback_setParentView_impl)(void *,KDDockWidgets::Core::View * parent);Callback_setParentView_impl m_setParentView_implCallback = nullptr;typedef KDDockWidgets::Core::DockWidget * (*Callback_singleDockWidget)(void *);Callback_singleDockWidget m_singleDockWidgetCallback = nullptr;
...
DOCKS_EXPORT void c_KDDockWidgets__Core__TitleBar__registerVirtualMethodCallback(void *ptr, void *callback, int methodId);DOCKS_EXPORT  void c_KDDockWidgets__Core__TitleBar_Finalizer(void *cppObj);}
