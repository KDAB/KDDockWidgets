...
~DockWidget_wrapper(); DockWidget_wrapper(KDDockWidgets::Core::View * view,const QString & uniqueName,QFlags<KDDockWidgets::DockWidgetOption> options = {},QFlags<KDDockWidgets::LayoutSaverOption> layoutSaverOptions = {});void aboutToDelete(KDDockWidgets::Core::DockWidget * arg__1);void aboutToDeleteOnClose();void actualTitleBarChanged();void addDockWidgetAsTab(KDDockWidgets::Core::DockWidget * other,KDDockWidgets::InitialOption initialOption = {});void addDockWidgetToContainingWindow(KDDockWidgets::Core::DockWidget * other,KDDockWidgets::Location location,KDDockWidgets::Core::DockWidget * relativeTo = nullptr,KDDockWidgets::InitialOption initialOption = {});static KDDockWidgets::Core::DockWidget * byName(const QString & uniqueName);void closed();int currentTabIndex()const;KDDockWidgets::Core::FloatingWindow * floatingWindow()const;void forceClose();QRect groupGeometry()const;void guestViewChanged();bool hasPreviousDockedLocation()const;void iconChanged();void init();bool isCurrentTab()const;bool isFloating()const;void isFloatingChanged(bool arg__1);bool isFocused()const;void isFocusedChanged(bool arg__1);bool isInMainWindow()const;bool isInSideBar()const;bool isMainWindow()const;bool isOpen()const;void isOpenChanged(bool isOpen);bool isOverlayed()const;void isOverlayedChanged(bool arg__1);bool isPersistentCentralDockWidget()const;bool isTabbed()const;QSize lastOverlayedSize()const;QFlags<KDDockWidgets::LayoutSaverOption> layoutSaverOptions()const;KDDockWidgets::Core::MainWindow * mainWindow()const;void moveToSideBar();void onResize(QSize newSize);void open();QFlags<KDDockWidgets::DockWidgetOption> options()const;void optionsChanged(QFlags<KDDockWidgets::DockWidgetOption> arg__1);void raise();void removedFromSideBar();void setAffinityName(const QString & name);void setAsCurrentTab();bool setFloating(bool floats);void setFloatingGeometry(QRect geo);void setMDIPosition(QPoint pos);void setMDISize(QSize size);void setMDIZ(int z);void setOptions(QFlags<KDDockWidgets::DockWidgetOption> arg__1);virtual void setParentView_impl(KDDockWidgets::Core::View * parent);virtual void setParentView_impl_nocallback(KDDockWidgets::Core::View * parent);void setTitle(const QString & title);void setUserType(int userType);void show();bool skipsRestore()const;int tabIndex()const;QString title()const;KDDockWidgets::Core::TitleBar * titleBar()const;void titleChanged(const QString & title);static QString tr(const char * s,const char * c,int n);QString uniqueName()const;int userType()const;void windowActiveAboutToChange(bool activated);typedef void (*Callback_setParentView_impl)(void *,KDDockWidgets::Core::View * parent);Callback_setParentView_impl m_setParentView_implCallback = nullptr;
...
KDDockWidgetsBindings_EXPORT void c_KDDockWidgets__Core__DockWidget__registerVirtualMethodCallback(void *ptr, void *callback, int methodId);KDDockWidgetsBindings_EXPORT  void c_KDDockWidgets__Core__DockWidget_Finalizer(void *, void *cppObj, void *);}
