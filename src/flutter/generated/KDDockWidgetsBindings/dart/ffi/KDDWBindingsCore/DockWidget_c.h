...
namespace KDDockWidgetsBindings_wrappersNS {namespace KDDWBindingsCore {class DockWidget_wrapper : public ::KDDockWidgets::Core::DockWidget {public:
~DockWidget_wrapper(); DockWidget_wrapper(KDDockWidgets::Core::View * view,const QString & uniqueName,QFlags<KDDockWidgets::DockWidgetOption> options = {},QFlags<KDDockWidgets::LayoutSaverOption> layoutSaverOptions = {});void addDockWidgetAsTab(KDDockWidgets::Core::DockWidget * other,const KDDockWidgets::InitialOption & initialOption = {});void addDockWidgetToContainingWindow(KDDockWidgets::Core::DockWidget * other,KDDockWidgets::Location location,KDDockWidgets::Core::DockWidget * relativeTo = nullptr,const KDDockWidgets::InitialOption & initialOption = {});static KDDockWidgets::Core::DockWidget * byName(const QString & uniqueName);int currentTabIndex()const;KDDockWidgets::Core::FloatingWindow * floatingWindow()const;void forceClose();KDDockWidgets::Rect groupGeometry()const;bool hasPreviousDockedLocation()const;void init();bool isCurrentTab()const;bool isFloating()const;bool isFocused()const;bool isInMainWindow()const;bool isInSideBar()const;bool isMainWindow()const;bool isOpen()const;bool isOverlayed()const;bool isPersistentCentralDockWidget()const;bool isTabbed()const;KDDockWidgets::Size lastOverlayedSize()const;QFlags<KDDockWidgets::LayoutSaverOption> layoutSaverOptions()const;KDDockWidgets::Core::MainWindow * mainWindow()const;int mdiZ()const;void moveToSideBar();void onResize(KDDockWidgets::Size newSize);void open();QFlags<KDDockWidgets::DockWidgetOption> options()const;void raise();void removeFromSideBar();void resizeInLayout(int left,int top,int right,int bottom);void setAffinityName(const QString & name);void setAsCurrentTab();bool setFloating(bool floats);void setFloatingGeometry(KDDockWidgets::Rect geo);void setMDIPosition(KDDockWidgets::Point pos);void setMDISize(KDDockWidgets::Size size);void setMDIZ(int z);void setOptions(QFlags<KDDockWidgets::DockWidgetOption> arg__1);virtual void setParentView_impl(KDDockWidgets::Core::View * parent);virtual void setParentView_impl_nocallback(KDDockWidgets::Core::View * parent);void setTitle(const QString & title);void setUniqueName(const QString & arg__1);void setUserType(int userType);void show();KDDockWidgets::Size sizeInLayout()const;bool skipsRestore()const;bool startDragging(bool singleTab = false);int tabIndex()const;QString title()const;KDDockWidgets::Core::TitleBar * titleBar()const;QString uniqueName()const;int userType()const;bool wasRestored()const;typedef void (*Callback_setParentView_impl)(void *,KDDockWidgets::Core::View * parent);Callback_setParentView_impl m_setParentView_implCallback = nullptr;
...
// KDDockWidgets::Core::DockWidget::addDockWidgetAsTab(KDDockWidgets::Core::DockWidget * other, const KDDockWidgets::InitialOption & initialOption)
...
// KDDockWidgets::Core::DockWidget::addDockWidgetToContainingWindow(KDDockWidgets::Core::DockWidget * other, KDDockWidgets::Location location, KDDockWidgets::Core::DockWidget * relativeTo, const KDDockWidgets::InitialOption & initialOption)
...
DOCKS_EXPORT void c_KDDockWidgets__Core__DockWidget__registerVirtualMethodCallback(void *ptr, void *callback, int methodId);DOCKS_EXPORT  void c_KDDockWidgets__Core__DockWidget_Finalizer(void *cppObj);}
