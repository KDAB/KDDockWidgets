...
namespace KDDockWidgetsBindings_wrappersNS {namespace KDDWBindingsCore {class Group_wrapper : public ::KDDockWidgets::Core::Group {public:
~Group_wrapper(); Group_wrapper(KDDockWidgets::Core::View * parent = nullptr);KDDockWidgets::Core::TitleBar * actualTitleBar()const;void actualTitleBarChanged();void addTab(KDDockWidgets::Core::DockWidget * arg__1,KDDockWidgets::InitialOption arg__2 = {});void addTab(KDDockWidgets::Core::FloatingWindow * floatingWindow,KDDockWidgets::InitialOption arg__2 = {});void addTab(KDDockWidgets::Core::Group * arg__1,KDDockWidgets::InitialOption arg__2 = {});bool allDockWidgetsHave(KDDockWidgets::DockWidgetOption arg__1)const;bool allDockWidgetsHave(KDDockWidgets::LayoutSaverOption arg__1)const;bool alwaysShowsTabs()const;bool anyDockWidgetsHas(KDDockWidgets::DockWidgetOption arg__1)const;bool anyDockWidgetsHas(KDDockWidgets::LayoutSaverOption arg__1)const;bool anyNonClosable()const;bool anyNonDockable()const;bool beingDeletedLater()const;QSize biggestDockWidgetMaxSize()const;bool containsDockWidget(KDDockWidgets::Core::DockWidget * w)const;bool containsMouse(QPoint globalPos)const;KDDockWidgets::Core::DockWidget * currentDockWidget()const;int currentIndex()const;int currentTabIndex()const;static int dbg_numFrames();KDDockWidgets::Core::FloatingWindow * detachTab(KDDockWidgets::Core::DockWidget * arg__1);KDDockWidgets::Core::DockWidget * dockWidgetAt(int index)const;int dockWidgetCount()const;QSize dockWidgetsMinSize()const;virtual QRect dragRect()const;virtual QRect dragRect_nocallback()const;KDDockWidgets::Core::FloatingWindow * floatingWindow()const;void focusedWidgetChanged();virtual void focusedWidgetChangedCallback();virtual void focusedWidgetChangedCallback_nocallback();bool hasNestedMDIDockWidgets()const;bool hasSingleDockWidget()const;bool hasTabsVisible()const;void hasTabsVisibleChanged();int indexOfDockWidget(const KDDockWidgets::Core::DockWidget * arg__1);void insertDockWidget(KDDockWidgets::Core::DockWidget * arg__1,int index);void insertWidget(KDDockWidgets::Core::DockWidget * arg__1,int index,KDDockWidgets::InitialOption arg__3 = {});bool isCentralFrame()const;bool isDockable()const;bool isEmpty()const;bool isFloating()const;void isFocusedChanged();virtual void isFocusedChangedCallback();virtual void isFocusedChangedCallback_nocallback();bool isInFloatingWindow()const;bool isInMainWindow()const;void isInMainWindowChanged();bool isMDI()const;void isMDIChanged();bool isMDIWrapper()const;bool isOverlayed()const;bool isTheOnlyFrame()const;KDDockWidgets::Core::Item * layoutItem()const;KDDockWidgets::Core::MainWindow * mainWindow()const;KDDockWidgets::Core::DockWidget * mdiDockWidgetWrapper()const;KDDockWidgets::Core::DropArea * mdiDropAreaWrapper()const;KDDockWidgets::Core::Group * mdiFrame()const;int nonContentsHeight()const;void numDockWidgetsChanged();void onDockWidgetCountChanged();void onDockWidgetTitleChanged();void removeWidget(KDDockWidgets::Core::DockWidget * arg__1);void renameTab(int index,const QString & arg__2);void restoreToPreviousPosition();void setCurrentDockWidget(KDDockWidgets::Core::DockWidget * arg__1);void setCurrentTabIndex(int index);void setLayout(KDDockWidgets::Core::Layout * arg__1);void setLayoutItem(KDDockWidgets::Core::Item * item);virtual void setParentView_impl(KDDockWidgets::Core::View * parent);virtual void setParentView_impl_nocallback(KDDockWidgets::Core::View * parent);KDDockWidgets::Core::Stack * stack()const;KDDockWidgets::Core::TabBar * tabBar()const;QString title()const;KDDockWidgets::Core::TitleBar * titleBar()const;static QString tr(const char * s,const char * c,int n);void unoverlay();void updateFloatingActions();void updateTitleAndIcon();void updateTitleBarVisibility();int userType()const;typedef QRect* (*Callback_dragRect)(void *);Callback_dragRect m_dragRectCallback = nullptr;typedef void (*Callback_focusedWidgetChangedCallback)(void *);Callback_focusedWidgetChangedCallback m_focusedWidgetChangedCallbackCallback = nullptr;typedef void (*Callback_isFocusedChangedCallback)(void *);Callback_isFocusedChangedCallback m_isFocusedChangedCallbackCallback = nullptr;typedef void (*Callback_setParentView_impl)(void *,KDDockWidgets::Core::View * parent);Callback_setParentView_impl m_setParentView_implCallback = nullptr;
...
KDDockWidgetsBindings_EXPORT void c_KDDockWidgets__Core__Group__registerVirtualMethodCallback(void *ptr, void *callback, int methodId);KDDockWidgetsBindings_EXPORT  void c_KDDockWidgets__Core__Group_Finalizer(void *, void *cppObj, void *);}
