...
~Group_wrapper(); Group_wrapper(KDDockWidgets::Core::View * parent = nullptr);KDDockWidgets::Core::TitleBar * actualTitleBar()const;void addTab(KDDockWidgets::Core::DockWidget * arg__1,const KDDockWidgets::InitialOption & arg__2 = {});void addTab(KDDockWidgets::Core::FloatingWindow * floatingWindow,const KDDockWidgets::InitialOption & arg__2 = {});void addTab(KDDockWidgets::Core::Group * arg__1,const KDDockWidgets::InitialOption & arg__2 = {});bool allDockWidgetsHave(KDDockWidgets::DockWidgetOption arg__1)const;bool allDockWidgetsHave(KDDockWidgets::LayoutSaverOption arg__1)const;bool alwaysShowsTabs()const;bool anyDockWidgetsHas(KDDockWidgets::DockWidgetOption arg__1)const;bool anyDockWidgetsHas(KDDockWidgets::LayoutSaverOption arg__1)const;bool anyNonClosable()const;bool anyNonDockable()const;bool beingDeletedLater()const;KDDockWidgets::Size biggestDockWidgetMaxSize()const;bool containsDockWidget(KDDockWidgets::Core::DockWidget * w)const;bool containsMouse(KDDockWidgets::Point globalPos)const;KDDockWidgets::Core::DockWidget * currentDockWidget()const;int currentIndex()const;int currentTabIndex()const;static int dbg_numFrames();KDDockWidgets::Core::FloatingWindow * detachTab(KDDockWidgets::Core::DockWidget * arg__1);KDDockWidgets::Core::DockWidget * dockWidgetAt(int index)const;int dockWidgetCount()const;KDDockWidgets::Size dockWidgetsMinSize()const;virtual KDDockWidgets::Rect dragRect()const;virtual KDDockWidgets::Rect dragRect_nocallback()const;KDDockWidgets::Core::FloatingWindow * floatingWindow()const;virtual void focusedWidgetChangedCallback();virtual void focusedWidgetChangedCallback_nocallback();static KDDockWidgets::Core::Group * fromItem(const KDDockWidgets::Core::Item * arg__1);bool hasNestedMDIDockWidgets()const;bool hasSingleDockWidget()const;bool hasTabsVisible()const;int indexOfDockWidget(const KDDockWidgets::Core::DockWidget * arg__1);void insertDockWidget(KDDockWidgets::Core::DockWidget * arg__1,int index);void insertWidget(KDDockWidgets::Core::DockWidget * arg__1,int index,const KDDockWidgets::InitialOption & arg__3 = {});bool isCentralGroup()const;bool isDockable()const;bool isEmpty()const;bool isFloating()const;virtual void isFocusedChangedCallback();virtual void isFocusedChangedCallback_nocallback();bool isInFloatingWindow()const;bool isInMainWindow()const;bool isMDI()const;bool isMDIWrapper()const;bool isOverlayed()const;bool isTheOnlyGroup()const;KDDockWidgets::Core::Item * layoutItem()const;KDDockWidgets::Core::MainWindow * mainWindow()const;KDDockWidgets::Core::DockWidget * mdiDockWidgetWrapper()const;KDDockWidgets::Core::DropArea * mdiDropAreaWrapper()const;KDDockWidgets::Core::Group * mdiFrame()const;int nonContentsHeight()const;void onDockWidgetCountChanged();void onDockWidgetTitleChanged(KDDockWidgets::Core::DockWidget * arg__1);void removeWidget(KDDockWidgets::Core::DockWidget * arg__1);void renameTab(int index,const QString & arg__2);void restoreToPreviousPosition();void setCurrentDockWidget(KDDockWidgets::Core::DockWidget * arg__1);void setCurrentTabIndex(int index);void setLayout(KDDockWidgets::Core::Layout * arg__1);void setLayoutItem(KDDockWidgets::Core::Item * item);virtual void setParentView_impl(KDDockWidgets::Core::View * parent);virtual void setParentView_impl_nocallback(KDDockWidgets::Core::View * parent);KDDockWidgets::Core::Stack * stack()const;KDDockWidgets::Core::TabBar * tabBar()const;QString title()const;KDDockWidgets::Core::TitleBar * titleBar()const;void unoverlay();void updateFloatingActions();void updateTitleAndIcon();void updateTitleBarVisibility();int userType()const;typedef KDDockWidgets::Rect* (*Callback_dragRect)(void *);Callback_dragRect m_dragRectCallback = nullptr;typedef void (*Callback_focusedWidgetChangedCallback)(void *);Callback_focusedWidgetChangedCallback m_focusedWidgetChangedCallbackCallback = nullptr;typedef void (*Callback_isFocusedChangedCallback)(void *);Callback_isFocusedChangedCallback m_isFocusedChangedCallbackCallback = nullptr;typedef void (*Callback_setParentView_impl)(void *,KDDockWidgets::Core::View * parent);Callback_setParentView_impl m_setParentView_implCallback = nullptr;
...
DOCKS_EXPORT void c_KDDockWidgets__Core__Group__registerVirtualMethodCallback(void *ptr, void *callback, int methodId);DOCKS_EXPORT  void c_KDDockWidgets__Core__Group_Finalizer(void *cppObj);}
