...
namespace KDDockWidgetsBindings_wrappersNS {namespace KDDWBindingsCore {class Controller_wrapper : public ::KDDockWidgets::Core::Controller {public:
~Controller_wrapper(); Controller_wrapper(KDDockWidgets::Core::ViewType type,KDDockWidgets::Core::View * arg__2);bool close();QRect geometry()const;int height()const;bool inDtor()const;bool isVisible()const;QPoint mapToGlobal(QPoint arg__1)const;void parentViewChanged(KDDockWidgets::Core::View * parent);QPoint pos()const;QRect rect()const;void setParentView(KDDockWidgets::Core::View * parent);virtual void setParentView_impl(KDDockWidgets::Core::View * parent);virtual void setParentView_impl_nocallback(KDDockWidgets::Core::View * parent);void setVisible(bool arg__1);void show()const;QSize size()const;static QString tr(const char * s,const char * c,int n);KDDockWidgets::Core::ViewType type()const;KDDockWidgets::Core::View * view()const;int width()const;int x()const;int y()const;typedef void (*Callback_setParentView_impl)(void *,KDDockWidgets::Core::View * parent);Callback_setParentView_impl m_setParentView_implCallback = nullptr;
...
KDDockWidgetsBindings_EXPORT void c_KDDockWidgets__Core__Controller__registerVirtualMethodCallback(void *ptr, void *callback, int methodId);KDDockWidgetsBindings_EXPORT  void c_KDDockWidgets__Core__Controller_Finalizer(void *, void *cppObj, void *);}
