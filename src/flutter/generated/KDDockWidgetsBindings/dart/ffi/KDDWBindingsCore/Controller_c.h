...
~Controller_wrapper(); Controller_wrapper(KDDockWidgets::Core::ViewType type,KDDockWidgets::Core::View * arg__2);bool close();void destroyLater();KDDockWidgets::Rect geometry()const;int height()const;bool inDtor()const;bool isFixedHeight()const;bool isFixedWidth()const;bool isVisible()const;KDDockWidgets::Point mapToGlobal(KDDockWidgets::Point arg__1)const;KDDockWidgets::Point pos()const;KDDockWidgets::Rect rect()const;void setParentView(KDDockWidgets::Core::View * parent);virtual void setParentView_impl(KDDockWidgets::Core::View * parent);virtual void setParentView_impl_nocallback(KDDockWidgets::Core::View * parent);void setVisible(bool arg__1);void show()const;KDDockWidgets::Size size()const;KDDockWidgets::Core::ViewType type()const;KDDockWidgets::Core::View * view()const;int width()const;int x()const;int y()const;typedef void (*Callback_setParentView_impl)(void *,KDDockWidgets::Core::View * parent);Callback_setParentView_impl m_setParentView_implCallback = nullptr;
...
DOCKS_EXPORT void c_KDDockWidgets__Core__Controller__registerVirtualMethodCallback(void *ptr, void *callback, int methodId);DOCKS_EXPORT  void c_KDDockWidgets__Core__Controller_Finalizer(void *cppObj);}
