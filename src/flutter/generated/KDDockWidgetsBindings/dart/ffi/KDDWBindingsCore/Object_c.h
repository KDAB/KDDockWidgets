...
namespace KDDockWidgetsBindings_wrappersNS {namespace KDDWBindingsCore {class Object_wrapper : public ::KDDockWidgets::Core::Object {public:
~Object_wrapper(); Object_wrapper(KDDockWidgets::Core::Object * parent = nullptr);QString objectName()const;KDDockWidgets::Core::Object * parent()const;void setObjectName(const QString & arg__1);void setParent(KDDockWidgets::Core::Object * parent);static QString tr(const char * arg__1);
...
DOCKS_EXPORT void c_KDDockWidgets__Core__Object__registerVirtualMethodCallback(void *ptr, void *callback, int methodId);DOCKS_EXPORT  void c_KDDockWidgets__Core__Object_Finalizer(void *cppObj);}
