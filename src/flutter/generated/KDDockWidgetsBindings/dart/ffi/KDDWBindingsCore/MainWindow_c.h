...
namespace KDDockWidgetsBindings_wrappersNS {namespace KDDWBindingsCore {class MainWindow_wrapper : public ::KDDockWidgets::Core::MainWindow {public:
~MainWindow_wrapper(); MainWindow_wrapper(KDDockWidgets::Core::View * view,const QString & uniqueName,QFlags<KDDockWidgets::MainWindowOption> options);void addDockWidget(KDDockWidgets::Core::DockWidget * dockWidget,KDDockWidgets::Location location,KDDockWidgets::Core::DockWidget * relativeTo = nullptr,const KDDockWidgets::InitialOption & initialOption = {});void addDockWidgetAsTab(KDDockWidgets::Core::DockWidget * dockwidget);void addDockWidgetToSide(KDDockWidgets::Core::DockWidget * dockWidget,KDDockWidgets::Location location,const KDDockWidgets::InitialOption & initialOption = {});bool anySideBarIsVisible()const;KDDockWidgets::Margins centerWidgetMargins()const;KDDockWidgets::Rect centralAreaGeometry()const;void clearSideBarOverlay(bool deleteGroup = true);bool closeDockWidgets(bool force = false);KDDockWidgets::Core::DropArea * dropArea()const;void init(const QString & name);bool isMDI()const;KDDockWidgets::Core::Layout * layout()const;void layoutEqually();void layoutParentContainerEqually(KDDockWidgets::Core::DockWidget * dockWidget);void moveToSideBar(KDDockWidgets::Core::DockWidget * dw);KDDockWidgets::Core::DropArea * multiSplitter()const;QFlags<KDDockWidgets::MainWindowOption> options()const;int overlayMargin()const;void overlayOnSideBar(KDDockWidgets::Core::DockWidget * dw);KDDockWidgets::Core::DockWidget * overlayedDockWidget()const;void restoreFromSideBar(KDDockWidgets::Core::DockWidget * dw);void setContentsMargins(int l,int t,int r,int b);void setOverlayMargin(int margin);virtual void setParentView_impl(KDDockWidgets::Core::View * parent);virtual void setParentView_impl_nocallback(KDDockWidgets::Core::View * parent);void setUniqueName(const QString & uniqueName);KDDockWidgets::Core::SideBar * sideBarForDockWidget(const KDDockWidgets::Core::DockWidget * dw)const;void toggleOverlayOnSideBar(KDDockWidgets::Core::DockWidget * dw);QString uniqueName()const;typedef void (*Callback_setParentView_impl)(void *,KDDockWidgets::Core::View * parent);Callback_setParentView_impl m_setParentView_implCallback = nullptr;
...
// KDDockWidgets::Core::MainWindow::addDockWidget(KDDockWidgets::Core::DockWidget * dockWidget, KDDockWidgets::Location location, KDDockWidgets::Core::DockWidget * relativeTo, const KDDockWidgets::InitialOption & initialOption)
...
// KDDockWidgets::Core::MainWindow::addDockWidgetToSide(KDDockWidgets::Core::DockWidget * dockWidget, KDDockWidgets::Location location, const KDDockWidgets::InitialOption & initialOption)
...
DOCKS_EXPORT void c_KDDockWidgets__Core__MainWindow__registerVirtualMethodCallback(void *ptr, void *callback, int methodId);DOCKS_EXPORT  void c_KDDockWidgets__Core__MainWindow_Finalizer(void *cppObj);}
