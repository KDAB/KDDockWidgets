...
bool Layout_wrapper::containsGroup(const KDDockWidgets::Core::Group * arg__1)const{return ::KDDockWidgets::Core::Layout::containsGroup(arg__1);}
...
KDDockWidgets::Core::Item * Layout_wrapper::itemForGroup(const KDDockWidgets::Core::Group * group)const{return ::KDDockWidgets::Core::Layout::itemForGroup(group);}
int Layout_wrapper::layoutHeight()const{return ::KDDockWidgets::Core::Layout::layoutHeight();}
KDDockWidgets::Size Layout_wrapper::layoutMaximumSizeHint()const{return ::KDDockWidgets::Core::Layout::layoutMaximumSizeHint();}
KDDockWidgets::Size Layout_wrapper::layoutMinimumSize()const{return ::KDDockWidgets::Core::Layout::layoutMinimumSize();}
KDDockWidgets::Size Layout_wrapper::layoutSize()const{return ::KDDockWidgets::Core::Layout::layoutSize();}
...
void Layout_wrapper::setLayoutMinimumSize(KDDockWidgets::Size arg__1){::KDDockWidgets::Core::Layout::setLayoutMinimumSize(arg__1);}
void Layout_wrapper::setLayoutSize(KDDockWidgets::Size arg__1){::KDDockWidgets::Core::Layout::setLayoutSize(arg__1);}
...
{return reinterpret_cast<KDDockWidgetsBindings_wrappersNS::KDDWBindingsCore::Layout_wrapper*>(ptr);}extern "C" {
 void c_KDDockWidgets__Core__Layout_Finalizer(void *cppObj){delete reinterpret_cast<KDDockWidgetsBindings_wrappersNS::KDDWBindingsCore::Layout_wrapper *>(cppObj);}void * c_KDDockWidgets__Core__Layout__constructor_ViewType_View(int arg__1,void* arg__2_)
{
...
//asDropArea() const
void* c_KDDockWidgets__Core__Layout__asDropArea(void *thisObj){const auto &result = fromPtr(thisObj)->asDropArea();return result;}
//checkSanity() const
bool c_KDDockWidgets__Core__Layout__checkSanity(void *thisObj){const auto &result = fromPtr(thisObj)->checkSanity();return result;}
//clearLayout()
...
bool c_KDDockWidgets__Core__Layout__containsGroup_Group(void *thisObj,void* arg__1_){auto arg__1 = reinterpret_cast<KDDockWidgets::Core::Group *>(arg__1_);const auto &result = fromPtr(thisObj)->containsGroup(arg__1);return result;}
//containsItem(const KDDockWidgets::Core::Item * arg__1) const
bool c_KDDockWidgets__Core__Layout__containsItem_Item(void *thisObj,void* arg__1_){auto arg__1 = reinterpret_cast<KDDockWidgets::Core::Item *>(arg__1_);const auto &result = fromPtr(thisObj)->containsItem(arg__1);return result;}
//count() const
int c_KDDockWidgets__Core__Layout__count(void *thisObj){const auto &result = fromPtr(thisObj)->count();return result;}
//dumpLayout() const
void c_KDDockWidgets__Core__Layout__dumpLayout(void *thisObj){fromPtr(thisObj)->dumpLayout();}
//floatingWindow() const
void* c_KDDockWidgets__Core__Layout__floatingWindow(void *thisObj){const auto &result = fromPtr(thisObj)->floatingWindow();return result;}
//isInMainWindow(bool honourNesting) const
bool c_KDDockWidgets__Core__Layout__isInMainWindow_bool(void *thisObj,bool honourNesting){const auto &result = fromPtr(thisObj)->isInMainWindow(honourNesting);return result;}
//itemForGroup(const KDDockWidgets::Core::Group * group) const
void* c_KDDockWidgets__Core__Layout__itemForGroup_Group(void *thisObj,void* group_){auto group = reinterpret_cast<KDDockWidgets::Core::Group *>(group_);const auto &result = fromPtr(thisObj)->itemForGroup(group);return result;}
//layoutHeight() const
int c_KDDockWidgets__Core__Layout__layoutHeight(void *thisObj){const auto &result = fromPtr(thisObj)->layoutHeight();return result;}
//layoutMaximumSizeHint() const
void* c_KDDockWidgets__Core__Layout__layoutMaximumSizeHint(void *thisObj){const auto &result = new Dartagnan::ValueWrapper<KDDockWidgets::Size>{fromPtr(thisObj)->layoutMaximumSizeHint()};return result;}
//layoutMinimumSize() const
void* c_KDDockWidgets__Core__Layout__layoutMinimumSize(void *thisObj){const auto &result = new Dartagnan::ValueWrapper<KDDockWidgets::Size>{fromPtr(thisObj)->layoutMinimumSize()};return result;}
//layoutSize() const
void* c_KDDockWidgets__Core__Layout__layoutSize(void *thisObj){const auto &result = new Dartagnan::ValueWrapper<KDDockWidgets::Size>{fromPtr(thisObj)->layoutSize()};return result;}
//layoutWidth() const
int c_KDDockWidgets__Core__Layout__layoutWidth(void *thisObj){const auto &result = fromPtr(thisObj)->layoutWidth();return result;}
//mainWindow(bool honourNesting) const
void* c_KDDockWidgets__Core__Layout__mainWindow_bool(void *thisObj,bool honourNesting){const auto &result = fromPtr(thisObj)->mainWindow(honourNesting);return result;}
//placeholderCount() const
int c_KDDockWidgets__Core__Layout__placeholderCount(void *thisObj){const auto &result = fromPtr(thisObj)->placeholderCount();return result;}
...
void c_KDDockWidgets__Core__Layout__setLayoutMinimumSize_Size(void *thisObj,void* arg__1_){assert(arg__1_);
auto &arg__1 = *reinterpret_cast<KDDockWidgets::Size *>(arg__1_);fromWrapperPtr(thisObj)->setLayoutMinimumSize(arg__1);}
//setLayoutSize(KDDockWidgets::Size arg__1)
void c_KDDockWidgets__Core__Layout__setLayoutSize_Size(void *thisObj,void* arg__1_){assert(arg__1_);
auto &arg__1 = *reinterpret_cast<KDDockWidgets::Size *>(arg__1_);fromPtr(thisObj)->setLayoutSize(arg__1);}
...
//visibleCount() const
int c_KDDockWidgets__Core__Layout__visibleCount(void *thisObj){const auto &result = fromPtr(thisObj)->visibleCount();return result;}
