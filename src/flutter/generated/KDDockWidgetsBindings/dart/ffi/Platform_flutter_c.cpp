...
Platform_flutter_wrapper::Platform_flutter_wrapper()
    : ::KDDockWidgets::flutter::Platform_flutter()
{
}
QString Platform_flutter_wrapper::applicationName() const
{
    if (m_applicationNameCallback) {
        ...
        return ::KDDockWidgets::flutter::Platform_flutter::applicationName();
    }
}
...
KDDockWidgets::Core::ViewFactory *Platform_flutter_wrapper::createDefaultViewFactory()
{
    if (m_createDefaultViewFactoryCallback) {
        ...
        return ::KDDockWidgets::flutter::Platform_flutter::createDefaultViewFactory();
    }
}
...
KDDockWidgets::Core::MainWindow *Platform_flutter_wrapper::createMainWindow(const QString &uniqueName, KDDockWidgets::Core::CreateViewOptions arg__2, QFlags<KDDockWidgets::MainWindowOption> options, KDDockWidgets::Core::View *parent, Qt::WindowFlags arg__5) const
{
    if (m_createMainWindowCallback) {
        ...
        return ::KDDockWidgets::flutter::Platform_flutter::createMainWindow(uniqueName, arg__2, options, parent, arg__5);
    }
}
...
KDDockWidgets::Core::View *Platform_flutter_wrapper::createView(KDDockWidgets::Core::Controller *controller, KDDockWidgets::Core::View *parent) const
{
    if (m_createViewCallback) {
        ...
        return ::KDDockWidgets::flutter::Platform_flutter::createView(controller, parent);
    }
}
...
QPoint Platform_flutter_wrapper::cursorPos() const
{
    if (m_cursorPosCallback) {
        ...
        return ::KDDockWidgets::flutter::Platform_flutter::cursorPos();
    }
}
...
bool Platform_flutter_wrapper::hasActivePopup() const
{
    if (m_hasActivePopupCallback) {
        ...
        return ::KDDockWidgets::flutter::Platform_flutter::hasActivePopup();
    }
}
...
bool Platform_flutter_wrapper::inDisallowedDragView(QPoint globalPos) const
{
    if (m_inDisallowedDragViewCallback) {
        ...
        return ::KDDockWidgets::flutter::Platform_flutter::inDisallowedDragView(globalPos);
    }
}
...
bool Platform_flutter_wrapper::isLeftMouseButtonPressed() const
{
    if (m_isLeftMouseButtonPressedCallback) {
        ...
        return ::KDDockWidgets::flutter::Platform_flutter::isLeftMouseButtonPressed();
    }
}
...
bool Platform_flutter_wrapper::isProcessingAppQuitEvent() const
{
    if (m_isProcessingAppQuitEventCallback) {
        ...
        return ::KDDockWidgets::flutter::Platform_flutter::isProcessingAppQuitEvent();
    }
}
...
const char *Platform_flutter_wrapper::name() const
{
    if (m_nameCallback) {
        ...
        return ::KDDockWidgets::flutter::Platform_flutter::name();
    }
}
...
void Platform_flutter_wrapper::onFloatingWindowCreated(KDDockWidgets::Core::FloatingWindow *arg__1)
{
    if (m_onFloatingWindowCreatedCallback) {
        ...
        ::KDDockWidgets::flutter::Platform_flutter::onFloatingWindowCreated(arg__1);
    }
}
...
void Platform_flutter_wrapper::onFloatingWindowDestroyed(KDDockWidgets::Core::FloatingWindow *arg__1)
{
    if (m_onFloatingWindowDestroyedCallback) {
        ...
        ::KDDockWidgets::flutter::Platform_flutter::onFloatingWindowDestroyed(arg__1);
    }
}
...
QString Platform_flutter_wrapper::organizationName() const
{
    if (m_organizationNameCallback) {
        ...
        return ::KDDockWidgets::flutter::Platform_flutter::organizationName();
    }
}
...
KDDockWidgets::flutter::Platform_flutter *Platform_flutter_wrapper::platformFlutter()
{
    return ::KDDockWidgets::flutter::Platform_flutter::platformFlutter();
}
...
int Platform_flutter_wrapper::screenNumberFor(KDDockWidgets::Core::View *arg__1) const
{
    if (m_screenNumberForCallback) {
        ...
        return ::KDDockWidgets::flutter::Platform_flutter::screenNumberFor(arg__1);
    }
}
...
QSize Platform_flutter_wrapper::screenSizeFor(KDDockWidgets::Core::View *arg__1) const
{
    if (m_screenSizeForCallback) {
        ...
        return ::KDDockWidgets::flutter::Platform_flutter::screenSizeFor(arg__1);
    }
}
...
void Platform_flutter_wrapper::setCursorPos(QPoint arg__1)
{
    if (m_setCursorPosCallback) {
        ...
        ::KDDockWidgets::flutter::Platform_flutter::setCursorPos(arg__1);
    }
}
...
void Platform_flutter_wrapper::setMouseCursor(Qt::CursorShape arg__1)
{
    if (m_setMouseCursorCallback) {
        ...
        ::KDDockWidgets::flutter::Platform_flutter::setMouseCursor(arg__1);
    }
}
...
int Platform_flutter_wrapper::startDragDistance_impl() const
{
    if (m_startDragDistance_implCallback) {
        ...
        return ::KDDockWidgets::flutter::Platform_flutter::startDragDistance_impl();
    }
}
...
KDDockWidgets::Core::View *Platform_flutter_wrapper::tests_createFocusableView(KDDockWidgets::Core::CreateViewOptions arg__1, KDDockWidgets::Core::View *parent)
{
    if (m_tests_createFocusableViewCallback) {
        ...
        return ::KDDockWidgets::flutter::Platform_flutter::tests_createFocusableView(arg__1, parent);
    }
}
...
KDDockWidgets::Core::View *Platform_flutter_wrapper::tests_createNonClosableView(KDDockWidgets::Core::View *parent)
{
    if (m_tests_createNonClosableViewCallback) {
        ...
        return ::KDDockWidgets::flutter::Platform_flutter::tests_createNonClosableView(parent);
    }
}
...
KDDockWidgets::Core::View *Platform_flutter_wrapper::tests_createView(KDDockWidgets::Core::CreateViewOptions arg__1, KDDockWidgets::Core::View *parent)
{
    if (m_tests_createViewCallback) {
        ...
        return ::KDDockWidgets::flutter::Platform_flutter::tests_createView(arg__1, parent);
    }
}
...
void Platform_flutter_wrapper::tests_doubleClickOn(QPoint globalPos, KDDockWidgets::Core::View *receiver)
{
    if (m_tests_doubleClickOnCallback) {
        ...
        ::KDDockWidgets::flutter::Platform_flutter::tests_doubleClickOn(globalPos, receiver);
    }
}
...
void Platform_flutter_wrapper::tests_wait(int ms)
{
    if (m_tests_waitCallback) {
        ...
        ::KDDockWidgets::flutter::Platform_flutter::tests_wait(ms);
    }
}
...
bool Platform_flutter_wrapper::usesFallbackMouseGrabber() const
{
    if (m_usesFallbackMouseGrabberCallback) {
        ...
        return ::KDDockWidgets::flutter::Platform_flutter::usesFallbackMouseGrabber();
    }
}
...
static KDDockWidgets::flutter::Platform_flutter *fromPtr(void *ptr)
{
    return reinterpret_cast<KDDockWidgets::flutter::Platform_flutter *>(ptr);
}
...
extern "C" {
void c_KDDockWidgets__flutter__Platform_flutter_Finalizer(void *, void *cppObj, void *)
{
