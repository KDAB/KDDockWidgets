...
public:
    ...
    KDDockWidgets::Controllers::SideBar *sideBarForDockWidget(const KDDockWidgets::Controllers::DockWidget *arg__1) const;
...
KDDockWidgetsBindings_EXPORT void c_KDDockWidgets__DockRegistry__customEvent_QEvent(void *thisObj, void *event_);
...
KDDockWidgetsBindings_EXPORT bool c_KDDockWidgets__DockRegistry__event_QEvent(void *thisObj, void *event_);
// KDDockWidgets::DockRegistry::eventFilter(QObject * watched, QEvent * event)
KDDockWidgetsBindings_EXPORT bool c_KDDockWidgets__DockRegistry__eventFilter_QObject_QEvent(void *thisObj, void *watched_, void *event_);
