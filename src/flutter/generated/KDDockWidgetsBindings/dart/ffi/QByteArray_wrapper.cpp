...
//tag=1006
QByteArray_wrapper::QByteArray_wrapper(const char * arg__1,int size) : ::QByteArray(arg__1,size) {}
...
{return reinterpret_cast<KDDockWidgetsBindings_wrappersNS::QByteArray_wrapper*>(ptr);}extern "C" {

//tag=1049
 void c_QByteArray_Finalizer(void *, void *cppObj, void *){delete reinterpret_cast<KDDockWidgetsBindings_wrappersNS::QByteArray_wrapper *>(cppObj);}void * c_QByteArray__constructor()
{

//tag=1056
auto ptr = new KDDockWidgetsBindings_wrappersNS::QByteArray_wrapper();return reinterpret_cast<void*>(ptr);}
void * c_QByteArray__constructor_char_int(const char * arg__1,int size)
{

//tag=1056
auto ptr = new KDDockWidgetsBindings_wrappersNS::QByteArray_wrapper(arg__1,size);return reinterpret_cast<void*>(ptr);}

//tag=1050
//append(const QByteArray & a)
void* c_QByteArray__append_QByteArray(void *thisObj,void* a_){auto &a = *reinterpret_cast<QByteArray *>(a_);return 
//tag=1010
...
//tag=1050
//append(const char * s)
void* c_QByteArray__append_char(void *thisObj,const char * s){return 
//tag=1010
...
void* c_QByteArray__append_char_int(void *thisObj,const char * s,int len){return 
//tag=1010
...
//tag=1050
//at(int i) const
char c_QByteArray__at_int(void *thisObj,int i){return 
//tag=1010
fromPtr(thisObj)->at(i);}

//tag=1050
//back() const
char c_QByteArray__back(void *thisObj){return 
//tag=1010
fromPtr(thisObj)->back();}

//tag=1050
//capacity() const
int c_QByteArray__capacity(void *thisObj){return 
//tag=1010
fromPtr(thisObj)->capacity();}

//tag=1050
//cbegin() const
const char * c_QByteArray__cbegin(void *thisObj){return 
//tag=1010
fromPtr(thisObj)->cbegin();}

//tag=1050
//cend() const
const char * c_QByteArray__cend(void *thisObj){return 
//tag=1010
...
void* c_QByteArray__chopped_int(void *thisObj,int len){return 
//tag=1010
...
int c_QByteArray__compare_QByteArray(void *thisObj,void* a_){auto &a = *reinterpret_cast<QByteArray *>(a_);return 
//tag=1010
fromPtr(thisObj)->compare(a);}

//tag=1050
//compare(const char * c) const
int c_QByteArray__compare_char(void *thisObj,const char * c){return 
//tag=1010
fromPtr(thisObj)->compare(c);}

//tag=1050
//constBegin() const
const char * c_QByteArray__constBegin(void *thisObj){return 
//tag=1010
fromPtr(thisObj)->constBegin();}

//tag=1050
//constData() const
const char * c_QByteArray__constData(void *thisObj){return 
//tag=1010
fromPtr(thisObj)->constData();}

//tag=1050
//constEnd() const
const char * c_QByteArray__constEnd(void *thisObj){return 
//tag=1010
fromPtr(thisObj)->constEnd();}

//tag=1050
//contains(const QByteArray & a) const
bool c_QByteArray__contains_QByteArray(void *thisObj,void* a_){auto &a = *reinterpret_cast<QByteArray *>(a_);return 
//tag=1010
fromPtr(thisObj)->contains(a);}

//tag=1050
//contains(const char * a) const
bool c_QByteArray__contains_char(void *thisObj,const char * a){return 
//tag=1010
fromPtr(thisObj)->contains(a);}

//tag=1050
//count() const
int c_QByteArray__count(void *thisObj){return 
//tag=1010
fromPtr(thisObj)->count();}

//tag=1050
//count(const QByteArray & a) const
int c_QByteArray__count_QByteArray(void *thisObj,void* a_){auto &a = *reinterpret_cast<QByteArray *>(a_);return 
//tag=1010
fromPtr(thisObj)->count(a);}

//tag=1050
//count(const char * a) const
int c_QByteArray__count_char(void *thisObj,const char * a){return 
//tag=1010
fromPtr(thisObj)->count(a);}
...
bool c_QByteArray__endsWith_QByteArray(void *thisObj,void* a_){auto &a = *reinterpret_cast<QByteArray *>(a_);return 
//tag=1010
fromPtr(thisObj)->endsWith(a);}

//tag=1050
//endsWith(const char * c) const
bool c_QByteArray__endsWith_char(void *thisObj,const char * c){return 
//tag=1010
fromPtr(thisObj)->endsWith(c);}

//tag=1050
//fromBase64(const QByteArray & base64)
void* c_static_QByteArray__fromBase64_QByteArray(void* base64_){auto &base64 = *reinterpret_cast<QByteArray *>(base64_);return 
//tag=1068

//tag=1072
new Dartagnan::ValueWrapper<QByteArray>{KDDockWidgetsBindings_wrappersNS::QByteArray_wrapper::fromBase64(base64)};}

//tag=1050
//fromHex(const QByteArray & hexEncoded)
void* c_static_QByteArray__fromHex_QByteArray(void* hexEncoded_){auto &hexEncoded = *reinterpret_cast<QByteArray *>(hexEncoded_);return 
//tag=1068

//tag=1072
new Dartagnan::ValueWrapper<QByteArray>{KDDockWidgetsBindings_wrappersNS::QByteArray_wrapper::fromHex(hexEncoded)};}

//tag=1050
//fromRawData(const char * arg__1, int size)
void* c_static_QByteArray__fromRawData_char_int(const char * arg__1,int size){return 
//tag=1068

//tag=1072
new Dartagnan::ValueWrapper<QByteArray>{KDDockWidgetsBindings_wrappersNS::QByteArray_wrapper::fromRawData(arg__1,size)};}

//tag=1050
//front() const
char c_QByteArray__front(void *thisObj){return 
//tag=1010
fromPtr(thisObj)->front();}

//tag=1050
//indexOf(const QByteArray & a, int from) const
int c_QByteArray__indexOf_QByteArray_int(void *thisObj,void* a_,int from){auto &a = *reinterpret_cast<QByteArray *>(a_);return 
//tag=1010
fromPtr(thisObj)->indexOf(a,from);}

//tag=1050
//indexOf(const char * c, int from) const
int c_QByteArray__indexOf_char_int(void *thisObj,const char * c,int from){return 
//tag=1010
fromPtr(thisObj)->indexOf(c,from);}

//tag=1050
//insert(int i, const QByteArray & a)
void* c_QByteArray__insert_int_QByteArray(void *thisObj,int i,void* a_){auto &a = *reinterpret_cast<QByteArray *>(a_);return 
//tag=1010
...
void* c_QByteArray__insert_int_char(void *thisObj,int i,const char * s){return 
//tag=1010
...
void* c_QByteArray__insert_int_char_int(void *thisObj,int i,const char * s,int len){return 
//tag=1010
...
//tag=1050
//isDetached() const
bool c_QByteArray__isDetached(void *thisObj){return 
//tag=1010
fromPtr(thisObj)->isDetached();}

//tag=1050
//isEmpty() const
bool c_QByteArray__isEmpty(void *thisObj){return 
//tag=1010
fromPtr(thisObj)->isEmpty();}

//tag=1050
//isLower() const
bool c_QByteArray__isLower(void *thisObj){return 
//tag=1010
fromPtr(thisObj)->isLower();}

//tag=1050
//isNull() const
bool c_QByteArray__isNull(void *thisObj){return 
//tag=1010
fromPtr(thisObj)->isNull();}

//tag=1050
//isSharedWith(const QByteArray & other) const
bool c_QByteArray__isSharedWith_QByteArray(void *thisObj,void* other_){auto &other = *reinterpret_cast<QByteArray *>(other_);return 
//tag=1010
fromPtr(thisObj)->isSharedWith(other);}

//tag=1050
//isUpper() const
bool c_QByteArray__isUpper(void *thisObj){return 
//tag=1010
fromPtr(thisObj)->isUpper();}

//tag=1050
//lastIndexOf(const QByteArray & a, int from) const
int c_QByteArray__lastIndexOf_QByteArray_int(void *thisObj,void* a_,int from){auto &a = *reinterpret_cast<QByteArray *>(a_);return 
//tag=1010
fromPtr(thisObj)->lastIndexOf(a,from);}

//tag=1050
//lastIndexOf(const char * c, int from) const
int c_QByteArray__lastIndexOf_char_int(void *thisObj,const char * c,int from){return 
//tag=1010
fromPtr(thisObj)->lastIndexOf(c,from);}

//tag=1050
//left(int len) const
void* c_QByteArray__left_int(void *thisObj,int len){return 
//tag=1010
...
//tag=1050
//length() const
int c_QByteArray__length(void *thisObj){return 
//tag=1010
fromPtr(thisObj)->length();}

//tag=1050
//mid(int index, int len) const
void* c_QByteArray__mid_int_int(void *thisObj,int index,int len){return 
//tag=1010
...
void* c_static_QByteArray__number_int_int(int arg__1,int base){return 
//tag=1068

//tag=1072
new Dartagnan::ValueWrapper<QByteArray>{KDDockWidgetsBindings_wrappersNS::QByteArray_wrapper::number(arg__1,base)};}

//tag=1050
//number(qint64 arg__1, int base)
void* c_static_QByteArray__number_qint64_int(qint64 arg__1,int base){return 
//tag=1068
...
void* c_QByteArray__prepend_QByteArray(void *thisObj,void* a_){auto &a = *reinterpret_cast<QByteArray *>(a_);return 
//tag=1010
...
void* c_QByteArray__prepend_char(void *thisObj,const char * s){return 
//tag=1010
...
void* c_QByteArray__prepend_char_int(void *thisObj,const char * s,int len){return 
//tag=1010
...
void c_QByteArray__push_back_QByteArray(void *thisObj,void* a_){auto &a = *reinterpret_cast<QByteArray *>(a_);
//tag=1010
...
void c_QByteArray__push_front_QByteArray(void *thisObj,void* a_){auto &a = *reinterpret_cast<QByteArray *>(a_);
//tag=1010
...
void* c_QByteArray__remove_int_int(void *thisObj,int index,int len){return 
//tag=1010
...
void* c_QByteArray__repeated_int(void *thisObj,int times){return 
//tag=1010
...
void* c_QByteArray__replace_QByteArray_QByteArray(void *thisObj,void* before_,void* after_){auto &before = *reinterpret_cast<QByteArray *>(before_);auto &after = *reinterpret_cast<QByteArray *>(after_);return 
//tag=1010
...
void* c_QByteArray__replace_QByteArray_char(void *thisObj,void* before_,const char * after){auto &before = *reinterpret_cast<QByteArray *>(before_);return 
//tag=1010
...
void* c_QByteArray__replace_char_QByteArray(void *thisObj,const char * before,void* after_){auto &after = *reinterpret_cast<QByteArray *>(after_);return 
//tag=1010
...
void* c_QByteArray__replace_char_char(void *thisObj,const char * before,const char * after){return 
//tag=1010
...
void* c_QByteArray__replace_char_int_char_int(void *thisObj,const char * before,int bsize,const char * after,int asize){return 
//tag=1010
...
void* c_QByteArray__replace_int_int_QByteArray(void *thisObj,int index,int len,void* s_){auto &s = *reinterpret_cast<QByteArray *>(s_);return 
//tag=1010
...
void* c_QByteArray__replace_int_int_char(void *thisObj,int index,int len,const char * s){return 
//tag=1010
...
void* c_QByteArray__replace_int_int_char_int(void *thisObj,int index,int len,const char * s,int alen){return 
//tag=1010
...
//tag=1050
//right(int len) const
void* c_QByteArray__right_int(void *thisObj,int len){return 
//tag=1010
...
void* c_QByteArray__setNum_int_int(void *thisObj,int arg__1,int base){return 
//tag=1010
...
void* c_QByteArray__setNum_qint64_int(void *thisObj,qint64 arg__1,int base){return 
//tag=1010
...
void* c_QByteArray__setNum_short_int(void *thisObj,short arg__1,int base){return 
//tag=1010
...
//tag=1050
//simplified()
void* c_QByteArray__simplified(void *thisObj){return 
//tag=1010
...
//tag=1050
//size() const
int c_QByteArray__size(void *thisObj){return 
//tag=1010
...
bool c_QByteArray__startsWith_QByteArray(void *thisObj,void* a_){auto &a = *reinterpret_cast<QByteArray *>(a_);return 
//tag=1010
fromPtr(thisObj)->startsWith(a);}

//tag=1050
//startsWith(const char * c) const
bool c_QByteArray__startsWith_char(void *thisObj,const char * c){return 
//tag=1010
fromPtr(thisObj)->startsWith(c);}

//tag=1050
//toBase64() const
void* c_QByteArray__toBase64(void *thisObj){return 
//tag=1010
...
//tag=1050
//toHex() const
void* c_QByteArray__toHex(void *thisObj){return 
//tag=1010
...
//tag=1050
//toLower()
void* c_QByteArray__toLower(void *thisObj){return 
//tag=1010
...
//tag=1050
//toUpper()
void* c_QByteArray__toUpper(void *thisObj){return 
//tag=1010
...
//tag=1050
//trimmed()
void* c_QByteArray__trimmed(void *thisObj){return 
//tag=1010
