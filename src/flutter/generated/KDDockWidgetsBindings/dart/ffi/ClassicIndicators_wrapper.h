...
KDDockWidgetsBindings_EXPORT void c_KDDockWidgets__Controllers__ClassicIndicators__customEvent_QEvent(void *thisObj, void *event_);
// KDDockWidgets::Controllers::ClassicIndicators::dropIndicatorVisible(KDDockWidgets::DropLocation arg__1) const
KDDockWidgetsBindings_EXPORT bool c_KDDockWidgets__Controllers__ClassicIndicators__dropIndicatorVisible_DropLocation(void *thisObj, int arg__1);
// KDDockWidgets::Controllers::ClassicIndicators::event(QEvent * event)
KDDockWidgetsBindings_EXPORT bool c_KDDockWidgets__Controllers__ClassicIndicators__event_QEvent(void *thisObj, void *event_);
// KDDockWidgets::Controllers::ClassicIndicators::eventFilter(QObject * watched, QEvent * event)
KDDockWidgetsBindings_EXPORT bool c_KDDockWidgets__Controllers__ClassicIndicators__eventFilter_QObject_QEvent(void *thisObj, void *watched_, void *event_);
...
KDDockWidgetsBindings_EXPORT void c_KDDockWidgets__Controllers__ClassicIndicators__onHoveredFrameChanged_Group(void *thisObj, void *arg__1_);
