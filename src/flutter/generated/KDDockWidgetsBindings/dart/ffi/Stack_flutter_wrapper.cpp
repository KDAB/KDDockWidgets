...
int Stack_flutter_wrapper::currentIndex() const
{
    if (m_currentIndexCallback) {
        const void *thisPtr = this;
        return m_currentIndexCallback(const_cast<void *>(thisPtr));
    } else {
        return ::KDDockWidgets::Views::Stack_flutter::currentIndex();
    }
}
int Stack_flutter_wrapper::currentIndex_nocallback() const
{
    return ::KDDockWidgets::Views::Stack_flutter::currentIndex();
}
...
QSize Stack_flutter_wrapper::maximumSize() const
{
    if (m_maximumSizeCallback) {
        const void *thisPtr = this;
        return *m_maximumSizeCallback(const_cast<void *>(thisPtr));
    } else {
        return ::KDDockWidgets::Views::Stack_flutter::maximumSize();
    }
}
QSize Stack_flutter_wrapper::maximumSize_nocallback() const
{
    return ::KDDockWidgets::Views::Stack_flutter::maximumSize();
}
...
int Stack_flutter_wrapper::numDockWidgets() const
{
    if (m_numDockWidgetsCallback) {
        const void *thisPtr = this;
        return m_numDockWidgetsCallback(const_cast<void *>(thisPtr));
    } else {
        return ::KDDockWidgets::Views::Stack_flutter::numDockWidgets();
    }
}
int Stack_flutter_wrapper::numDockWidgets_nocallback() const
{
    return ::KDDockWidgets::Views::Stack_flutter::numDockWidgets();
}
...
void Stack_flutter_wrapper::renameTab(int index, const QString &arg__2)
{
    if (m_renameTabCallback) {
        const void *thisPtr = this;
        m_renameTabCallback(const_cast<void *>(thisPtr), index, arg__2);
    } else {
        ::KDDockWidgets::Views::Stack_flutter::renameTab(index, arg__2);
    }
}
void Stack_flutter_wrapper::renameTab_nocallback(int index, const QString &arg__2)
{
    ::KDDockWidgets::Views::Stack_flutter::renameTab(index, arg__2);
}
void Stack_flutter_wrapper::setCurrentDockWidget(int index)
{
    if (m_setCurrentDockWidgetCallback) {
        const void *thisPtr = this;
        m_setCurrentDockWidgetCallback(const_cast<void *>(thisPtr), index);
    } else {
        ::KDDockWidgets::Views::Stack_flutter::setCurrentDockWidget(index);
    }
}
void Stack_flutter_wrapper::setCurrentDockWidget_nocallback(int index)
{
    ::KDDockWidgets::Views::Stack_flutter::setCurrentDockWidget(index);
}
...
void Stack_flutter_wrapper::setGeometry(QRect arg__1)
{
    if (m_setGeometryCallback) {
        const void *thisPtr = this;
        m_setGeometryCallback(const_cast<void *>(thisPtr), arg__1);
    } else {
        ::KDDockWidgets::Views::Stack_flutter::setGeometry(arg__1);
    }
}
void Stack_flutter_wrapper::setGeometry_nocallback(QRect arg__1)
{
    ::KDDockWidgets::Views::Stack_flutter::setGeometry(arg__1);
}
...
void Stack_flutter_wrapper::setZOrder(int arg__1)
{
    if (m_setZOrderCallback) {
        const void *thisPtr = this;
        m_setZOrderCallback(const_cast<void *>(thisPtr), arg__1);
    } else {
        ::KDDockWidgets::Views::Stack_flutter::setZOrder(arg__1);
    }
}
void Stack_flutter_wrapper::setZOrder_nocallback(int arg__1)
{
    ::KDDockWidgets::Views::Stack_flutter::setZOrder(arg__1);
}
...
{
    return [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgetsBindings_wrappersNS::Stack_flutter_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->currentIndex_nocallback();} else {    return targetPtr->currentIndex();} }();
}
// flags() const
...
{
    return new Dartagnan::ValueWrapper<QSize> { [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgetsBindings_wrappersNS::Stack_flutter_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->maximumSize_nocallback();} else {    return targetPtr->maximumSize();} }() };
}
// minSize() const
...
{
    return [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgetsBindings_wrappersNS::Stack_flutter_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->numDockWidgets_nocallback();} else {    return targetPtr->numDockWidgets();} }();
}
// objectName() const
...
bool c_KDDockWidgets__Views__Stack_flutter__onResize_QSize(void *thisObj, void *newSize_)
{
    ...
    return [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgetsBindings_wrappersNS::Stack_flutter_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->onResize_nocallback(newSize);} else {    return targetPtr->onResize(newSize);} }();
}
// raise()
...
void c_KDDockWidgets__Views__Stack_flutter__renameTab_int_QString(void *thisObj, int index, const char *arg__2_)
{
    ...
    [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgetsBindings_wrappersNS::Stack_flutter_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->renameTab_nocallback(index,arg__2);} else {    return targetPtr->renameTab(index,arg__2);} }();
}
...
{
    [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgetsBindings_wrappersNS::Stack_flutter_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->setCurrentDockWidget_nocallback(index);} else {    return targetPtr->setCurrentDockWidget(index);} }();
}
...
void c_KDDockWidgets__Views__Stack_flutter__setGeometry_QRect(void *thisObj, void *arg__1_)
{
    ...
    [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgetsBindings_wrappersNS::Stack_flutter_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->setGeometry_nocallback(arg__1);} else {    return targetPtr->setGeometry(arg__1);} }();
}
// setHeight(int h)
...
{
    [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgetsBindings_wrappersNS::Stack_flutter_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->setZOrder_nocallback(arg__1);} else {    return targetPtr->setZOrder(arg__1);} }();
}
// show()
...
void c_KDDockWidgets__Views__Stack_flutter__registerVirtualMethodCallback(void *ptr, void *callback, int methodId)
{
    ...
    case 842:
        ...
        break;
    case 972:
        wrapper->m_currentIndexCallback = reinterpret_cast<KDDockWidgetsBindings_wrappersNS::Stack_flutter_wrapper::Callback_currentIndex>(callback);
        break;
    case 847:
    ...
    case 872:
        ...
        break;
    case 873:
        wrapper->m_maximumSizeCallback = reinterpret_cast<KDDockWidgetsBindings_wrappersNS::Stack_flutter_wrapper::Callback_maximumSize>(callback);
        break;
    case 874:
    ...
    case 879:
        ...
        break;
    case 974:
        wrapper->m_numDockWidgetsCallback = reinterpret_cast<KDDockWidgetsBindings_wrappersNS::Stack_flutter_wrapper::Callback_numDockWidgets>(callback);
        break;
    case 880:
        ...
        break;
    case 881:
        wrapper->m_onResizeCallback = reinterpret_cast<KDDockWidgetsBindings_wrappersNS::Stack_flutter_wrapper::Callback_onResize>(callback);
        break;
    case 884:
    ...
    case 888:
        ...
        break;
    case 975:
        wrapper->m_renameTabCallback = reinterpret_cast<KDDockWidgetsBindings_wrappersNS::Stack_flutter_wrapper::Callback_renameTab>(callback);
        break;
    case 976:
        wrapper->m_setCurrentDockWidgetCallback = reinterpret_cast<KDDockWidgetsBindings_wrappersNS::Stack_flutter_wrapper::Callback_setCurrentDockWidget>(callback);
        break;
    case 892:
