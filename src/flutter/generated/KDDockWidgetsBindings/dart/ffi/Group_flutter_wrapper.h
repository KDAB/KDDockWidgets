...
extern "C" {
// KDDockWidgets::Views::Group_flutter::Group_flutter(KDDockWidgets::Core::Group * controller, KDDockWidgets::Core::View * parent)
...
KDDockWidgetsBindings_EXPORT void c_KDDockWidgets__Views__Group_flutter__onChildAdded_View(void *thisObj, void *childView_);
// KDDockWidgets::Views::Group_flutter::onChildRemoved(KDDockWidgets::Core::View * childView)
KDDockWidgetsBindings_EXPORT void c_KDDockWidgets__Views__Group_flutter__onChildRemoved_View(void *thisObj, void *childView_);
// KDDockWidgets::Views::Group_flutter::onResize(int w, int h)
KDDockWidgetsBindings_EXPORT bool c_KDDockWidgets__Views__Group_flutter__onResize_int_int(void *thisObj, int w, int h);
...
KDDockWidgetsBindings_EXPORT void c_KDDockWidgets__Views__Group_flutter__setGeometry_QRect(void *thisObj, void *geometry_);
...
KDDockWidgetsBindings_EXPORT void c_KDDockWidgets__Views__Group_flutter__setZOrder_int(void *thisObj, int z);
