...
public:
    ...
    virtual KDDockWidgets::View *createFloatingWindow(KDDockWidgets::Controllers::FloatingWindow *arg__1, KDDockWidgets::Controllers::MainWindow *parent = nullptr, Qt::WindowFlags windowFlags = {}) const;
    virtual KDDockWidgets::View *createFloatingWindow_nocallback(KDDockWidgets::Controllers::FloatingWindow *arg__1, KDDockWidgets::Controllers::MainWindow *parent = nullptr, Qt::WindowFlags windowFlags = {}) const;
    ...
    virtual KDDockWidgets::View *createSeparator(KDDockWidgets::Controllers::Separator *arg__1, KDDockWidgets::View *parent = nullptr) const;
    virtual KDDockWidgets::View *createSeparator_nocallback(KDDockWidgets::Controllers::Separator *arg__1, KDDockWidgets::View *parent = nullptr) const;
    virtual KDDockWidgets::View *createSideBar(KDDockWidgets::Controllers::SideBar *arg__1, KDDockWidgets::View *parent) const;
    virtual KDDockWidgets::View *createSideBar_nocallback(KDDockWidgets::Controllers::SideBar *arg__1, KDDockWidgets::View *parent) const;
    ...
    typedef KDDockWidgets::View *(*Callback_createFloatingWindow)(void *, KDDockWidgets::Controllers::FloatingWindow *arg__1, KDDockWidgets::Controllers::MainWindow *parent, Qt::WindowFlags windowFlags);
    ...
    typedef KDDockWidgets::View *(*Callback_createSeparator)(void *, KDDockWidgets::Controllers::Separator *arg__1, KDDockWidgets::View *parent);
    Callback_createSeparator m_createSeparatorCallback = nullptr;
    typedef KDDockWidgets::View *(*Callback_createSideBar)(void *, KDDockWidgets::Controllers::SideBar *arg__1, KDDockWidgets::View *parent);
