...
public:
    ...
    virtual KDDockWidgets::View *createFloatingWindow(KDDockWidgets::Core::FloatingWindow *arg__1, KDDockWidgets::Core::MainWindow *parent = nullptr, Qt::WindowFlags windowFlags = {}) const;
    virtual KDDockWidgets::View *createFloatingWindow_nocallback(KDDockWidgets::Core::FloatingWindow *arg__1, KDDockWidgets::Core::MainWindow *parent = nullptr, Qt::WindowFlags windowFlags = {}) const;
    ...
    virtual KDDockWidgets::View *createStack(KDDockWidgets::Core::Stack *arg__1, KDDockWidgets::View *parent) const;
    virtual KDDockWidgets::View *createStack_nocallback(KDDockWidgets::Core::Stack *arg__1, KDDockWidgets::View *parent) const;
    ...
    virtual KDDockWidgets::View *createTitleBar(KDDockWidgets::Core::TitleBar *arg__1, KDDockWidgets::View *parent) const;
    virtual KDDockWidgets::View *createTitleBar_nocallback(KDDockWidgets::Core::TitleBar *arg__1, KDDockWidgets::View *parent) const;
    ...
    typedef KDDockWidgets::View *(*Callback_createFloatingWindow)(void *, KDDockWidgets::Core::FloatingWindow *arg__1, KDDockWidgets::Core::MainWindow *parent, Qt::WindowFlags windowFlags);
    ...
    typedef KDDockWidgets::View *(*Callback_createStack)(void *, KDDockWidgets::Core::Stack *arg__1, KDDockWidgets::View *parent);
    ...
    typedef KDDockWidgets::View *(*Callback_createTitleBar)(void *, KDDockWidgets::Core::TitleBar *arg__1, KDDockWidgets::View *parent);
