...
QSize TabBar_flutter_wrapper::maximumSize() const
{
    if (m_maximumSizeCallback) {
        const void *thisPtr = this;
        return *m_maximumSizeCallback(const_cast<void *>(thisPtr));
    } else {
        return ::KDDockWidgets::Views::TabBar_flutter::maximumSize();
    }
}
QSize TabBar_flutter_wrapper::maximumSize_nocallback() const
{
    return ::KDDockWidgets::Views::TabBar_flutter::maximumSize();
}
...
void TabBar_flutter_wrapper::setGeometry(QRect arg__1)
{
    if (m_setGeometryCallback) {
        const void *thisPtr = this;
        m_setGeometryCallback(const_cast<void *>(thisPtr), arg__1);
    } else {
        ::KDDockWidgets::Views::TabBar_flutter::setGeometry(arg__1);
    }
}
void TabBar_flutter_wrapper::setGeometry_nocallback(QRect arg__1)
{
    ::KDDockWidgets::Views::TabBar_flutter::setGeometry(arg__1);
}
...
void TabBar_flutter_wrapper::setZOrder(int arg__1)
{
    if (m_setZOrderCallback) {
        const void *thisPtr = this;
        m_setZOrderCallback(const_cast<void *>(thisPtr), arg__1);
    } else {
        ::KDDockWidgets::Views::TabBar_flutter::setZOrder(arg__1);
    }
}
void TabBar_flutter_wrapper::setZOrder_nocallback(int arg__1)
{
    ::KDDockWidgets::Views::TabBar_flutter::setZOrder(arg__1);
}
...
{
    return new Dartagnan::ValueWrapper<QSize> { [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgetsBindings_wrappersNS::TabBar_flutter_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->maximumSize_nocallback();} else {    return targetPtr->maximumSize();} }() };
}
// minSize() const
...
bool c_KDDockWidgets__Views__TabBar_flutter__onResize_QSize(void *thisObj, void *newSize_)
{
    ...
    return [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgetsBindings_wrappersNS::TabBar_flutter_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->onResize_nocallback(newSize);} else {    return targetPtr->onResize(newSize);} }();
}
// raise()
...
void c_KDDockWidgets__Views__TabBar_flutter__setGeometry_QRect(void *thisObj, void *arg__1_)
{
    ...
    [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgetsBindings_wrappersNS::TabBar_flutter_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->setGeometry_nocallback(arg__1);} else {    return targetPtr->setGeometry(arg__1);} }();
}
// setHeight(int h)
...
{
    [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgetsBindings_wrappersNS::TabBar_flutter_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->setZOrder_nocallback(arg__1);} else {    return targetPtr->setZOrder(arg__1);} }();
}
// show()
...
{
    return [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgetsBindings_wrappersNS::TabBar_flutter_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->tabsAreMovable_nocallback();} else {    return targetPtr->tabsAreMovable();} }();
}
...
void c_KDDockWidgets__Views__TabBar_flutter__registerVirtualMethodCallback(void *ptr, void *callback, int methodId)
{
    ...
    case 872:
        ...
        break;
    case 873:
        wrapper->m_maximumSizeCallback = reinterpret_cast<KDDockWidgetsBindings_wrappersNS::TabBar_flutter_wrapper::Callback_maximumSize>(callback);
        break;
    case 874:
    ...
    case 880:
        ...
        break;
    case 881:
        wrapper->m_onResizeCallback = reinterpret_cast<KDDockWidgetsBindings_wrappersNS::TabBar_flutter_wrapper::Callback_onResize>(callback);
        break;
    case 884:
    ...
    case 967:
        ...
        break;
    case 968:
        wrapper->m_tabsAreMovableCallback = reinterpret_cast<KDDockWidgetsBindings_wrappersNS::TabBar_flutter_wrapper::Callback_tabsAreMovable>(callback);
        break;
    case 969:
