...
void MainWindow_wrapper::free_impl()
{
...
void MainWindow_wrapper::free_impl_nocallback()
{
    ::KDDockWidgets::flutter::MainWindow::free_impl();
}
...
{
    [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgetsBindings_wrappersNS::KDDWBindingsFlutter::MainWindow_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->free_impl_nocallback();} else {    return targetPtr->free_impl();} }();
}
// geometry() const
...
void c_KDDockWidgets__flutter__MainWindow__registerVirtualMethodCallback(void *ptr, void *callback, int methodId)
{
    ...
    case 930:
        ...
        break;
    case 932:
        wrapper->m_free_implCallback = reinterpret_cast<KDDockWidgetsBindings_wrappersNS::KDDWBindingsFlutter::MainWindow_wrapper::Callback_free_impl>(callback);
        break;
    case 934:
