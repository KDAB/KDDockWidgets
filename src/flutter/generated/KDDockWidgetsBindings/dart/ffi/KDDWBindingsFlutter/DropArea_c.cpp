...
bool DropArea_wrapper::isExpicitlyHidden() const
{
    if (m_isExpicitlyHiddenCallback) {
        const void *thisPtr = this;
        return m_isExpicitlyHiddenCallback(const_cast<void *>(thisPtr));
    } else {
        return ::KDDockWidgets::flutter::DropArea::isExpicitlyHidden();
    }
}
bool DropArea_wrapper::isExpicitlyHidden_nocallback() const
{
    return ::KDDockWidgets::flutter::DropArea::isExpicitlyHidden();
}
...
bool c_KDDockWidgets__flutter__DropArea__isExpicitlyHidden(void *thisObj)
{
    return [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgetsBindings_wrappersNS::KDDWBindingsFlutter::DropArea_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->isExpicitlyHidden_nocallback();} else {    return targetPtr->isExpicitlyHidden();} }();
}
// isMaximized() const
...
void c_KDDockWidgets__flutter__DropArea__registerVirtualMethodCallback(void *ptr, void *callback, int methodId)
{
    ...
    case 951:
        ...
        break;
    case 952:
        wrapper->m_isExpicitlyHiddenCallback = reinterpret_cast<KDDockWidgetsBindings_wrappersNS::KDDWBindingsFlutter::DropArea_wrapper::Callback_isExpicitlyHidden>(callback);
        break;
    case 953:
