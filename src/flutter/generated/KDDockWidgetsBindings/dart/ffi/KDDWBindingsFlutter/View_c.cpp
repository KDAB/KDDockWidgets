...
bool View_wrapper::isExpicitlyHidden() const
{
    if (m_isExpicitlyHiddenCallback) {
        ...
        return ::KDDockWidgets::flutter::View::isExpicitlyHidden();
    }
}
...
{
    return [&] {auto targetPtr = fromPtr(thisObj);auto wrapperPtr = dynamic_cast<KDDockWidgetsBindings_wrappersNS::KDDWBindingsFlutter::View_wrapper*>(targetPtr);if (wrapperPtr) {    return wrapperPtr->isExpicitlyHidden_nocallback();} else {    return targetPtr->isExpicitlyHidden();} }();
}
// isMaximized() const
...
void c_KDDockWidgets__flutter__View__registerVirtualMethodCallback(void *ptr, void *callback, int methodId)
{
    ...
    case 951:
        ...
        break;
    case 952:
        wrapper->m_isExpicitlyHiddenCallback = reinterpret_cast<KDDockWidgetsBindings_wrappersNS::KDDWBindingsFlutter::View_wrapper::Callback_isExpicitlyHidden>(callback);
        break;
    case 953:
