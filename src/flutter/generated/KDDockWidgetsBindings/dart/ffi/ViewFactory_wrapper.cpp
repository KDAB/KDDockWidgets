...
KDDockWidgets::View *ViewFactory_wrapper::createFloatingWindow(KDDockWidgets::Controllers::FloatingWindow *controller, KDDockWidgets::Controllers::MainWindow *parent, Qt::WindowFlags windowFlags) const
{
...
KDDockWidgets::View *ViewFactory_wrapper::createFloatingWindow_nocallback(KDDockWidgets::Controllers::FloatingWindow *controller, KDDockWidgets::Controllers::MainWindow *parent, Qt::WindowFlags windowFlags) const
{
    qWarning() << Q_FUNC_INFO << "Warning: Calling pure-virtual";
    return {};
}
...
KDDockWidgets::View *ViewFactory_wrapper::createSeparator(KDDockWidgets::Controllers::Separator *arg__1, KDDockWidgets::View *parent) const
{
...
KDDockWidgets::View *ViewFactory_wrapper::createSeparator_nocallback(KDDockWidgets::Controllers::Separator *arg__1, KDDockWidgets::View *parent) const
{
    qWarning() << Q_FUNC_INFO << "Warning: Calling pure-virtual";
    return {};
}
KDDockWidgets::View *ViewFactory_wrapper::createSideBar(KDDockWidgets::Controllers::SideBar *arg__1, KDDockWidgets::View *parent) const
{
...
KDDockWidgets::View *ViewFactory_wrapper::createSideBar_nocallback(KDDockWidgets::Controllers::SideBar *arg__1, KDDockWidgets::View *parent) const
{
    qWarning() << Q_FUNC_INFO << "Warning: Calling pure-virtual";
    return {};
}
