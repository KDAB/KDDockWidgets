...
class Stack_flutter extends View_flutter {
  ...
  static ffi.Pointer<void> maximumSize_calledFromC(ffi.Pointer<void> thisCpp) {
    ...
    if (dartInstance == null) {
      print(
          "Dart instance not found for Stack_flutter::maximumSize() const! (${thisCpp.address})");
      throw Error();
    }
  ...
  static void setGeometry_calledFromC(
    ...
    if (dartInstance == null) {
      print(
          "Dart instance not found for Stack_flutter::setGeometry(QRect arg__1)! (${thisCpp.address})");
      throw Error();
    }
  ...
  static void setZOrder_calledFromC(ffi.Pointer<void> thisCpp, int arg__1) {
    ...
    if (dartInstance == null) {
      print(
          "Dart instance not found for Stack_flutter::setZOrder(int arg__1)! (${thisCpp.address})");
      throw Error();
    }
  ...
  String cFunctionSymbolName(int methodId) {
    switch (methodId) {
      ...
      case 892:
        return "c_KDDockWidgets__Views__Stack_flutter__maximumSize";
      case 893:
  ...
  void registerCallbacks() {
    ...
    final callback991 = ffi.Pointer.fromFunction<int_Func_voidstar_FFI>(
        Stack_flutter.currentIndex_calledFromC, callbackExcept991);
    ...
    final callback992 =
        ffi.Pointer.fromFunction<bool_Func_voidstar_voidstar_FFI>(
            Stack_flutter.isPositionDraggable_calledFromC, callbackExcept992);
    ...
    final callback993 = ffi.Pointer.fromFunction<int_Func_voidstar_FFI>(
        Stack_flutter.numDockWidgets_calledFromC, callbackExcept993);
