...
class Stack_flutter extends View_flutter {
  ...
  void registerCallbacks() {
    ...
    final callback972 = ffi.Pointer.fromFunction<int_Func_voidstar_FFI>(
        Stack_flutter.currentIndex_calledFromC, callbackExcept972);
    ...
    final callback973 =
        ffi.Pointer.fromFunction<bool_Func_voidstar_voidstar_FFI>(
            Stack_flutter.isPositionDraggable_calledFromC, callbackExcept973);
    ...
    final callback974 = ffi.Pointer.fromFunction<int_Func_voidstar_FFI>(
        Stack_flutter.numDockWidgets_calledFromC, callbackExcept974);
