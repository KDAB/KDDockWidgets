...
class TitleBar extends Controller {
  ...
  void registerCallbacks() {
    ...
    final callback1093 = ffi.Pointer.fromFunction<bool_Func_voidstar_FFI>(
        TitleBar.isMDI_calledFromC, callbackExcept1093);
    ...
    final callback1096 = ffi.Pointer.fromFunction<bool_Func_voidstar_FFI>(
        TitleBar.isWindow_calledFromC, callbackExcept1096);
    registerCallback(thisCpp, callback1096, 1096);
    final callback888 =
        ffi.Pointer.fromFunction<void_Func_voidstar_voidstar_FFI>(
            Controller.setParentView_impl_calledFromC);
    registerCallback(thisCpp, callback888, 888);
    final callback1116 = ffi.Pointer.fromFunction<voidstar_Func_voidstar_FFI>(
