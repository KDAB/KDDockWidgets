...
class Item extends QObject {
  ...
  void registerCallbacks() {
    ...
    final callback858 = ffi.Pointer.fromFunction<int_Func_voidstar_FFI>(
        Item.visibleCount_recursive_calledFromC, callbackExcept858);
