...
class TitleBar_flutter extends View_flutter {
  ...
  void registerCallbacks() {
    ...
    final callback1038 = ffi.Pointer.fromFunction<bool_Func_voidstar_FFI>(
        TitleBar_flutter.isCloseButtonEnabled_calledFromC, callbackExcept1038);
    registerCallback(thisCpp, callback1038, 1038);
    const callbackExcept1039 = 0;
    final callback1039 = ffi.Pointer.fromFunction<bool_Func_voidstar_FFI>(
        TitleBar_flutter.isCloseButtonVisible_calledFromC, callbackExcept1039);
    ...
    final callback1040 = ffi.Pointer.fromFunction<bool_Func_voidstar_FFI>(
        TitleBar_flutter.isFloatButtonVisible_calledFromC, callbackExcept1040);
