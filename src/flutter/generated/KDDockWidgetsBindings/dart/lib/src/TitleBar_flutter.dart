...
class TitleBar_flutter extends View_flutter {
  ...
  void registerCallbacks() {
    ...
    final callback971 = ffi.Pointer.fromFunction<bool_Func_voidstar_FFI>(
        TitleBar_flutter.isCloseButtonEnabled_calledFromC, callbackExcept971);
    registerCallback(thisCpp, callback971, 971);
    const callbackExcept972 = 0;
    final callback972 = ffi.Pointer.fromFunction<bool_Func_voidstar_FFI>(
        TitleBar_flutter.isCloseButtonVisible_calledFromC, callbackExcept972);
    registerCallback(thisCpp, callback972, 972);
    const callbackExcept973 = 0;
    final callback973 = ffi.Pointer.fromFunction<bool_Func_voidstar_FFI>(
        TitleBar_flutter.isFloatButtonVisible_calledFromC, callbackExcept973);
