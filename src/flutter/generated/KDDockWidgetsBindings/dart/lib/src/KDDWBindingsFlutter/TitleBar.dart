...
class TitleBar extends KDDWBindingsFlutter.View {
  ...
  void registerCallbacks() {
    ...
    const callbackExcept815 = 0;
    final callback815 = ffi.Pointer.fromFunction<bool_Func_voidstar_FFI>(
    ...
    final callback816 = ffi.Pointer.fromFunction<bool_Func_voidstar_FFI>(
    ...
    const callbackExcept817 = 0;
    final callback817 = ffi.Pointer.fromFunction<bool_Func_voidstar_FFI>(
