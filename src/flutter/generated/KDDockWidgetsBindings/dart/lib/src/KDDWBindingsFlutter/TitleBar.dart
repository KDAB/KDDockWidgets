...
class TitleBar extends KDDWBindingsFlutter.View {
  ...
  void registerCallbacks() {
    ...
    const callbackExcept1051 = 0;
    final callback1051 = ffi.Pointer.fromFunction<bool_Func_voidstar_FFI>(
    ...
    final callback1052 = ffi.Pointer.fromFunction<bool_Func_voidstar_FFI>(
