...
class IndicatorWindow extends KDDWBindingsFlutter.View {
  ...
  void registerCallbacks() {
    ...
    final callback1752 = ffi.Pointer.fromFunction<
            bool_Func_voidstar_ffi_Int32_ffi_Int32_voidstar_ffi_Int32_FFI>(
