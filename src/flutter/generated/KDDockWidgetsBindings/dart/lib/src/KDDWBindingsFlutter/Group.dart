...
class Group extends KDDWBindingsFlutter.View {
  ...
  void registerCallbacks() {
    ...
    final callback514 = ffi.Pointer.fromFunction<voidstar_Func_voidstar_FFI>(
    ...
    const callbackExcept515 = 0;
    final callback515 = ffi.Pointer.fromFunction<int_Func_voidstar_FFI>(
