...
class Group extends KDDWBindingsFlutter.View {
  ...
  static ffi.Pointer<void> childViewAt_flutter_calledFromC(
    ...
    if (dartInstance == null) {
      print(
          "Dart instance not found for Group::childViewAt_flutter(QPoint localPos) const! (${thisCpp.address})");
      throw Error();
    }
    final result =
  ...
  String cFunctionSymbolName(int methodId) {
    switch (methodId) {
      ...
      case 1029:
        return "c_KDDockWidgets__flutter__Group__childViewAt_flutter_QPoint";
      case 933:
  ...
  void registerCallbacks() {
    ...
    final callback1109 = ffi.Pointer.fromFunction<voidstar_Func_voidstar_FFI>(
    ...
    const callbackExcept1110 = 0;
    final callback1110 = ffi.Pointer.fromFunction<int_Func_voidstar_FFI>(
        KDDWBindingsFlutter.Group.nonContentsHeight_calledFromC,
        callbackExcept1110);
    registerCallback(thisCpp, callback1110, 1110);
