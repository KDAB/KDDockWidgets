...
class TabBar extends KDDWBindingsFlutter.View {
  ...
  void registerCallbacks() {
    ...
    registerCallback(thisCpp, callback819, 819);
    final callback820 =
    ...
    const callbackExcept822 = 0;
    final callback822 =
        ffi.Pointer.fromFunction<int_Func_voidstar_voidstar_FFI>(
            KDDWBindingsFlutter.TabBar.tabAt_calledFromC, callbackExcept822);
