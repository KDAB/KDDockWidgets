...
class Platform implements ffi.Finalizable {
  ...
  static // hasInstance()
    ...
    final bool_Func_void func = _dylib
        .lookup<ffi.NativeFunction<bool_Func_void_FFI>>(
            'c_static_KDDockWidgets__Core__Platform__hasInstance')
        .asFunction();
    return func() != 0;
  ...
  String cFunctionSymbolName(int methodId) {
    switch (methodId) {
      ...
      case 156:
        return "c_KDDockWidgets__Core__Platform__onViewFactoryChanged";
      case 157:
