...
class Group extends KDDWBindingsCore.Controller {
  ...
  actualTitleBarChanged() {
    final void_Func_voidstar func = _dylib
        .lookup<ffi.NativeFunction<void_Func_voidstar_FFI>>(
            'c_KDDockWidgets__Core__Group__actualTitleBarChanged')
        .asFunction();
    func(thisCpp);
  ...
  bool containsMouse(QPoint globalPos) {
    final bool_Func_voidstar_voidstar func = _dylib
        .lookup<ffi.NativeFunction<bool_Func_voidstar_voidstar_FFI>>(
            'c_KDDockWidgets__Core__Group__containsMouse_QPoint')
        .asFunction();
  ...
  focusedWidgetChanged() {
    final void_Func_voidstar func = _dylib
        .lookup<ffi.NativeFunction<void_Func_voidstar_FFI>>(
            'c_KDDockWidgets__Core__Group__focusedWidgetChanged')
        .asFunction();
    func(thisCpp);
  ...
  hasTabsVisibleChanged() {
    final void_Func_voidstar func = _dylib
        .lookup<ffi.NativeFunction<void_Func_voidstar_FFI>>(
            'c_KDDockWidgets__Core__Group__hasTabsVisibleChanged')
        .asFunction();
    func(thisCpp);
  ...
  isFocusedChanged() {
    final void_Func_voidstar func = _dylib
        .lookup<ffi.NativeFunction<void_Func_voidstar_FFI>>(
            'c_KDDockWidgets__Core__Group__isFocusedChanged')
        .asFunction();
    func(thisCpp);
  ...
  isInMainWindowChanged() {
    final void_Func_voidstar func = _dylib
        .lookup<ffi.NativeFunction<void_Func_voidstar_FFI>>(
            'c_KDDockWidgets__Core__Group__isInMainWindowChanged')
        .asFunction();
    func(thisCpp);
  } // isMDI() const
  ...
  isMDIChanged() {
    final void_Func_voidstar func = _dylib
        .lookup<ffi.NativeFunction<void_Func_voidstar_FFI>>(
            'c_KDDockWidgets__Core__Group__isMDIChanged')
        .asFunction();
    func(thisCpp);
  } // isMDIWrapper() const
  ...
  numDockWidgetsChanged() {
    final void_Func_voidstar func = _dylib
        .lookup<ffi.NativeFunction<void_Func_voidstar_FFI>>(
            'c_KDDockWidgets__Core__Group__numDockWidgetsChanged')
        .asFunction();
    func(thisCpp);
  ...
  onDockWidgetTitleChanged() {
    final void_Func_voidstar func = _dylib
        .lookup<ffi.NativeFunction<void_Func_voidstar_FFI>>(
            'c_KDDockWidgets__Core__Group__onDockWidgetTitleChanged')
        .asFunction();
    func(thisCpp);
  ...
  static // tr(const char * s, const char * c, int n)
    ...
    final voidstar_Func_string_string_int func = _dylib
        .lookup<ffi.NativeFunction<voidstar_Func_string_string_ffi_Int32_FFI>>(
            'c_static_KDDockWidgets__Core__Group__tr_char_char_int')
        .asFunction();
  ...
  void registerCallbacks() {
    ...
    final RegisterMethodIsReimplementedCallback registerCallback = _dylib
        ...
        .asFunction();
    final callback1415 = ffi.Pointer.fromFunction<voidstar_Func_voidstar_FFI>(
        KDDWBindingsCore.Group.dragRect_calledFromC);
    registerCallback(thisCpp, callback1415, 1415);
    final callback1418 = ffi.Pointer.fromFunction<void_Func_voidstar_FFI>(
        KDDWBindingsCore.Group.focusedWidgetChangedCallback_calledFromC);
    registerCallback(thisCpp, callback1418, 1418);
    final callback1435 = ffi.Pointer.fromFunction<void_Func_voidstar_FFI>(
        KDDWBindingsCore.Group.isFocusedChangedCallback_calledFromC);
    registerCallback(thisCpp, callback1435, 1435);
    final callback827 =
