...
class FloatingWindow extends KDDWBindingsCore.Controller {
  ...
  void registerCallbacks() {
    ...
    final RegisterMethodIsReimplementedCallback registerCallback = _dylib
        ...
        .asFunction();
    const callbackExcept1563 = 0;
    final callback1563 = ffi.Pointer.fromFunction<bool_Func_voidstar_FFI>(
        KDDWBindingsCore.FloatingWindow.isMDI_calledFromC, callbackExcept1563);
    registerCallback(thisCpp, callback1563, 1563);
    const callbackExcept1566 = 0;
    final callback1566 = ffi.Pointer.fromFunction<bool_Func_voidstar_FFI>(
        KDDWBindingsCore.FloatingWindow.isWindow_calledFromC,
        callbackExcept1566);
    registerCallback(thisCpp, callback1566, 1566);
    final callback893 =
        ffi.Pointer.fromFunction<void_Func_voidstar_voidstar_FFI>(
            KDDWBindingsCore.Controller.setParentView_impl_calledFromC);
    registerCallback(thisCpp, callback893, 893);
    final callback1585 = ffi.Pointer.fromFunction<voidstar_Func_voidstar_FFI>(
