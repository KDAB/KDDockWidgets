...
class FloatingWindow extends KDDWBindingsCore.Controller {
  ...
  void registerCallbacks() {
    ...
    final RegisterMethodIsReimplementedCallback registerCallback = _dylib
        ...
        .asFunction();
    const callbackExcept1620 = 0;
    final callback1620 = ffi.Pointer.fromFunction<bool_Func_voidstar_FFI>(
        KDDWBindingsCore.FloatingWindow.isMDI_calledFromC, callbackExcept1620);
    registerCallback(thisCpp, callback1620, 1620);
    const callbackExcept1623 = 0;
    final callback1623 = ffi.Pointer.fromFunction<bool_Func_voidstar_FFI>(
    ...
    final callback1642 = ffi.Pointer.fromFunction<voidstar_Func_voidstar_FFI>(
        KDDWBindingsCore.FloatingWindow.singleDockWidget_calledFromC);
    registerCallback(thisCpp, callback1642, 1642);
  }
}
