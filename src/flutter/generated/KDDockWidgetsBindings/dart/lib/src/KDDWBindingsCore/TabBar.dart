...
class TabBar extends KDDWBindingsCore.Controller {
  ...
  void registerCallbacks() {
    ...
    final RegisterMethodIsReimplementedCallback registerCallback = _dylib
        ...
        .asFunction();
    const callbackExcept1209 = 0;
    final callback1209 =
        ffi.Pointer.fromFunction<bool_Func_voidstar_voidstar_voidstar_FFI>(
            KDDWBindingsCore.TabBar.dragCanStart_calledFromC,
            callbackExcept1209);
    registerCallback(thisCpp, callback1209, 1209);
    const callbackExcept1217 = 0;
    final callback1217 = ffi.Pointer.fromFunction<bool_Func_voidstar_FFI>(
        KDDWBindingsCore.TabBar.isMDI_calledFromC, callbackExcept1217);
    registerCallback(thisCpp, callback1217, 1217);
    const callbackExcept1219 = 0;
    final callback1219 = ffi.Pointer.fromFunction<bool_Func_voidstar_FFI>(
        KDDWBindingsCore.TabBar.isWindow_calledFromC, callbackExcept1219);
