...
class ViewFactory extends KDDWBindingsCore.Object {
  ...
  static ffi.Pointer<void> classicIndicatorsPath_calledFromC(
      ffi.Pointer<void> thisCpp) {
    var dartInstance = KDDWBindingsCore
        .Object.s_dartInstanceByCppPtr[thisCpp.address] as ViewFactory;
    if (dartInstance == null) {
      print(
          "Dart instance not found for ViewFactory::classicIndicatorsPath() const! (${thisCpp.address})");
      throw Error();
    }
    final result = dartInstance.classicIndicatorsPath();
  ...
  String cFunctionSymbolName(int methodId) {
    switch (methodId) {
      case 240:
        return "c_KDDockWidgets__Core__ViewFactory__classicIndicatorsPath";
      case 241:
