...
class ClassicIndicatorWindowViewInterface implements ffi.Finalizable {
  ...
  void registerCallbacks() {
    ...
    const callbackExcept1671 = 0;
    final callback1671 = ffi.Pointer.fromFunction<bool_Func_voidstar_FFI>(
        KDDWBindingsCore
            .ClassicIndicatorWindowViewInterface.isWindow_calledFromC,
        callbackExcept1671);
    registerCallback(thisCpp, callback1671, 1671);
    final callback1672 =
        ffi.Pointer.fromFunction<voidstar_Func_voidstar_ffi_Int32_FFI>(
            KDDWBindingsCore.ClassicIndicatorWindowViewInterface
                .posForIndicator_calledFromC);
    registerCallback(thisCpp, callback1672, 1672);
    final callback1673 = ffi.Pointer.fromFunction<void_Func_voidstar_FFI>(
    ...
    registerCallback(thisCpp, callback1675, 1675);
    final callback1676 =
        ffi.Pointer.fromFunction<void_Func_voidstar_voidstar_FFI>(
            KDDWBindingsCore
    ...
    final callback1678 = ffi.Pointer.fromFunction<void_Func_voidstar_FFI>(
        KDDWBindingsCore
