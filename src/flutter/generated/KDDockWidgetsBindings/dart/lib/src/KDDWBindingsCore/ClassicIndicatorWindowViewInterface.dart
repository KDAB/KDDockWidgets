...
class ClassicIndicatorWindowViewInterface implements ffi.Finalizable {
  ...
  void registerCallbacks() {
    ...
    final RegisterMethodIsReimplementedCallback registerCallback = _dylib
        ...
        .asFunction();
    const callbackExcept1445 = 0;
    final callback1445 =
        ffi.Pointer.fromFunction<int_Func_voidstar_voidstar_FFI>(
            KDDWBindingsCore
                .ClassicIndicatorWindowViewInterface.hover_calledFromC,
            callbackExcept1445);
    registerCallback(thisCpp, callback1445, 1445);
    const callbackExcept1446 = 0;
    final callback1446 = ffi.Pointer.fromFunction<bool_Func_voidstar_FFI>(
        KDDWBindingsCore
            .ClassicIndicatorWindowViewInterface.isWindow_calledFromC,
        callbackExcept1446);
    registerCallback(thisCpp, callback1446, 1446);
    final callback1447 =
        ffi.Pointer.fromFunction<voidstar_Func_voidstar_ffi_Int32_FFI>(
            KDDWBindingsCore.ClassicIndicatorWindowViewInterface
                .posForIndicator_calledFromC);
    registerCallback(thisCpp, callback1447, 1447);
    final callback1448 = ffi.Pointer.fromFunction<void_Func_voidstar_FFI>(
    ...
    final callback1454 = ffi.Pointer.fromFunction<void_Func_voidstar_FFI>(
        KDDWBindingsCore
            .ClassicIndicatorWindowViewInterface.updatePositions_calledFromC);
    registerCallback(thisCpp, callback1454, 1454);
  }
}
