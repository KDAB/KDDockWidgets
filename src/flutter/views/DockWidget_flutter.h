 ...
 */
class DOCKS_EXPORT DockWidget_flutter : public Views::View_flutter, public Views::DockWidgetViewInterface
{
public:
     ...
     */
    explicit DockWidget_flutter(const QString &uniqueName,
                                DockWidgetOptions = {},
                                LayoutSaverOptions = {},
