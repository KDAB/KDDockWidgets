...
enum RestoreOption {
    ...
    RestoreOption_CloseUnknownDockWidgets =
        4, ///< Closes dock widgets that are docked in a main window being restored but aren't
           ///< part of the saved layout. By default they are floated instead.
};
