...
#ifndef KDDOCKWIDGETS_ViewFactory_dummy_H
#define KDDOCKWIDGETS_ViewFactory_dummy_H
#pragma once
...
class DOCKS_EXPORT ViewFactory_dummy : public ViewFactory
{
    Q_OBJECT
public:
    ViewFactory_dummy() = default;
    ~ViewFactory_dummy() override;
...
private:
    Q_DISABLE_COPY(ViewFactory_dummy)
};
